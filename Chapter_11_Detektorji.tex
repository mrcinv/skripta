...
\beq
\overline{n} = \overline{P}/h\nu.
\eeq
Pri vpadu fotonov gre za diskretne in neodvisne procese, zato verjetnost, 
da v intervalu dolžine $\tau$, ki prestavlja čas merjenja, na detektor vpade
$N$ fotonov, opišemo s Poissonovo porazdelitvijo (slika~\ref{11_Poiss}).
Verjetnost, da bomo v času $\tau$ zaznali $N$ fotonov, je tako
\beq
...
in varianca $\sigma^2 = \overline{(N-\overline{N})^2} = \overline{N^2}-\overline{N}^2 = \overline{N}$.
\label{nal:Poiss}
\end{definition}
Odstopanje števila fotonov, ki vpadejo na detektor v danem časovnem intervalu, od povprečne vrednosti
označimo z $\Delta N = N-\overline{N}$. V povprečju je ta vrednost seveda enaka nič, 
...
\label{sigma}
\eeq
Standardni odklon, ki je merilo za velikost šuma, torej narašča z naraščajočim $\overline{N}$. 
Vendar nas absolutni šum večinoma ne zanima, saj je pri detekciji ključno razmerje 
signal proti šumu. To količino označimo s $SNR$ ({\it Signal to Noise Ratio}-- razmerje med 
...
Vidimo, da razmerje signal proti šumu narašča z naraščajočim svetlobnim tokom, 
torej relativni šum pojema. Za primer poglejmo dva primera vpadne svetlobe. 
...
Pri šumu štetja gre za značilnost svetlobe, zato je ta vrsta šuma
...
\eeq
Povprečni tok, ki steče skozi detektor, je tako 
\beq
\overline{I} = \frac{\overline{N}_e e_0}{\tau}.
\eeq
Odstopanja izhodnega električnega toka so
\beq
...
\begin{remark}
Razmerje signal proti šumu $SNR$ lahko vpeljemo na dva načina. Prvi je ta, ki smo ga 
...
\beq
NEP\, \frac{e_0}{h \nu} \eta = \sqrt{2 \overline{I}\,e_0\, \Delta\nu_B}.
\eeq
Sledi
\beq
NEP = \frac{h \nu}{\eta e_0}\sqrt{2 \overline{I}\,e_0\, \Delta\nu_B}.
\eeq
\begin{definition}
...
Termični šum imenujemo tudi Johnsonov ali Nykvistov ali Johnson-Nyquistov šum. 
Ta šum je najpogosteje omejujoči šum pri detekciji. Do njega pride zaradi 
naključnega gibanja elektronov v uporniku z upornostjo $R$, 
...
\beq
\sqrt{\overline{\Delta I^2}} = \sqrt{2\overline{I}_t\, e_0\, \Delta \nu_B}.
\eeq

GLEJ Pollock, šum zaradi nastanka para in šum zaradi difuzije. pri končnih temperaturah
...
kjer še telesa pri sobni temperaturi oddajajo znatno sevanje. Zato take detektorje pogosto
izolirajo od okolice in hladijo. 
