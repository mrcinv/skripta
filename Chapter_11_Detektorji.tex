...
Pri kvantni detekciji svetlobe vpeljemo še en parameter, ki ga imenujemo kvantni izkoristek $\eta$.
...
je kvatni izkoristek praktično enak nič, nato pa strmo naraste in 
...
in merimo električni tok, ki steče med katodo in anodo. Ker je sorazmeren s številom 
vpadlih fotonov, lahko izmerimo moč vpadne svetlobe.
...
Dodaten problem fotocelic je, da pri končnih temperaturah prihaja tudi do spontane oddaje elektrona.
Nekaj električnega toka zato teče tudi v popolni temi. To je temni tok fotodiode in tipično dosega
vrednosti okoli $10^{-15}~\si{\ampere}$, lahko pa tudi do več nA. 
...
Pri tem $I_0$ označuje tok manjšinskih nosilcev naboja (zaporni tok, tok nasičenja ali temni tok) 
in je navadno zelo majhen, okoli $10^{-5}$-$10^{-15}~\si{\ampere}$. Odvisen je od izbire
snovi, površine detektorja, predvsem pa je eksponentno 
...
intrinzičnem) sloju $p$-$n$ stika oziroma v njegovi bližini, steče elektron pod vplivom 
električnega polja na stran $n$, vrzel pa na stran $p$. Premik nosilcev naboja povzroči 
sunek toka, ki je odvisen od moči vpadne svetlobe in teče vedno v zaporni smeri. 
Lahko ga zapišemo kot 
\boxeq{11:if}{
I_f = e_0 \eta N_F = e_0 \frac{\eta P}{h \nu},
}
pri čemer smo z $N_F$ onačili število vpadnih fotonov na časovno enoto, $\eta$ je kvantni izkoristek,
...
Svetloba torej povzroči zmanjšanje električnega toka skozi diodo, kar na sliki~(\ref{11_IU})
predstavlja premik karakteristike diode v vertikalni smeri. Naraščajoča intenziteta svetlobe 
premika krivuljo proti bolj negativnim vrednostim tokov, pri čemer je odvisnost linearna
in neodvisna od priključene napetosti. 
