...
šuma je zato najbolj pomembna pri zaznavanju šibkih signalov svetlobe. Pri tem je pomemben
...
Ko govorimo o vpadni moči svetlobe na danem detektorju, ne smemo pozabiti, da 
je svetloba sestavljena iz fotonov. Fotoni vpadajo na detektor posamezno in enkrat jih vpade malo več, 
...
\label{Poisson}
\eeq
pri čemer je povprečno število vpadlih fotonov v tem časovnem intervalu enako $\overline{N} = \overline{n}\tau$.
\begin{figure}[h]
\centering
\def\svgwidth{80truemm} 
...
ne ustvarjajo termičnega šuma.

steče tok, tudi če ni napetosti. V povprečju je nič, varianca pa ni.
