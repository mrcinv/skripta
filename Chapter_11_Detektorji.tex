...
fluktuacije na izhodu iz detektorja, ki jih ne moremo ločiti od signala, in 
pridejo do izraza predvsem pri zaznavanju šibkih signalov svetlobe. 
...
ne smemo pozabiti, da je svetloba sestavljena iz posameznih fotonov: enkrat vpade več
fotonov, drugič manj. Moč, o kateri govorimo, je dejansko povprečna moč $\overline{P}$ in število 
...
\eeq
pri čemer smo privzeli, da ima detektor popoln kvantni izkoristek. Ker gre pri vpadu fotonov 
za diskretne in neodvisne procese, verjetnost, da v intervalu dolžine $\tau$ vpade
...
\label{nal:Poiss}
\end{definition}
Odstopanje števila fotonov v danem časovnem intervalu od povprečne vrednosti $\Delta N = N-\overline{N}$ 
je v povprečju seveda enako nič, zato sta bolj merodajna varianca, ki je enaka (glej nalogo~\ref{nal:Poiss})
\beq
\sigma^2 = \overline{(N-\overline{N})^2} = \overline{\Delta N^2} = \overline{N},
\eeq
in standardni odklon
\beq
\sigma = \sqrt{\overline{(N-\overline{N})^2}} = \sqrt{\overline{\Delta N^2}} = \sqrt{\overline{N}}.
\eeq
Vidimo, da šum (standardni odklon) narašča z naraščajočim $\overline{N}$. Vendar nas absolutni 
šum večinoma ne zanima, saj je pri detekciji svetlobe ključno razmerje signal proti šumu \footnote{Za to 
razmerje se navadno uporablja oznako $S/N$. Tukaj smo jo zaradi jasnosti zamenjali s 
$S/\check{S}$, saj $N$ označuje število fotonov oziroma
elektronov.}
\beq
\frac{S}{\check{S}} = \frac{\overline{N}}{\sigma} = \sqrt{\overline{N}}.
\eeq
Relativni šum torej z naraščajočim svetlobnim tokom pojema. Za primer poglejmo dva primera detekcije. 
V prvem je povprečno število vpadlih fotonov na dan časovni interval $10^6$, v drugem pa le $100$. 
...
\begin{remark}
Razmerje signal proti šumu lahko vpeljemo na dva načina. Lahko ga vpeljemo, kot 
smo ga vpeljali mi ($\overline{N}/\sigma$), pri čemer gre za razmerje signala električnega toka (ali 
električne napetosti) proti šumu. Drug način je kot $\overline{N}^2/\sigma^2$, pri čemer gre za razmerje
moči signala proti šumu. 
\end{remark}

Zapišimo zdaj izhodni električni tok iz detektorja. 
