...
V grobem delimo detektorje na termične in kvantne. Podrobneje bomo obravnavali 
le kvantne detektorje, predvsem polprevodniške fotodiode in nazadnje spoznali 
šum, ki omejuje uporabnost naprav.
...
polarizacija odvisna od temperature (npr. LiTaO$_3$ ali triglicin sulfat TGS). 
...
s tem pa tudi na spreminjanje vpadne sveltobne moči. V stacionarnem stanju 
...
elektronsko vezje, ki določa zgornjo mejo za frekvenco.

\begin{definition}
Piroelektrični detektor naredimo iz kristala TGS s koeficientom piroelektričnosti
$a = 280~{\si \micro \coloumb /\metre^2 \kelvin}$ specifično toploto
$c = 2,3\times 10^6~{\si \joule /\metre^4 \kelvin}$.
Izračunaj električno upornost sistema
\end{definition}
