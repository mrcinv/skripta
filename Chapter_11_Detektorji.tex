...
v različnih smereh. Če je dioda v odprtem električnem krogu, se pojavi električna napetost
in dioda deluje v t.i. fotovoltaičnem načinu. Če pa diodo priključimo v zaprt električni 
krog, steče tok. Na diode navadno priključimo dodatno napetost v zaporni smeri,
tako da je tok skozi diodo linearno sorazmeren z intenziteto vpadne svetlobe.

Spektralni odziv fotodiod je seveda odvisen od energijske reže polprevodnika. Silicijeve
fotodiode so tako uporabne za zaznavanje valovnih dolžin do okoli $1,1~\si{\micro\meter}$, za
...
Stik p-n pomeni stik dveh različno dopiranih polprevodnikov. Pri tem tip $p$ označuje
...
premakne proti valenčnem pasu (
slika~\ref{11_PN1}). Po drugi strani $n$ tip označuje polprevodnike s petvalentnimi 
...
Fermijevi energiji izenačita. Med obema polprevodnikoma se pojavi izpraznjeni sloj. }
\label{11_PN1}
\end{figure}
...
\begin{definition}
 Pokaži, da je širina izpraznjenega sloja na stiku p-n enaka 
 \beq
 d = \sqrt{\frac{4 \varepsilon \varepsilon_0 V_0}{e n_d}}, 
 \eeq
 pri čemer je ..
\end{definition}

Ko na diodo priključimo napetost, se potencialna razlika med $p$ in $n$ stranjo 
spremeni. Napetost $U$ je pozitivna, če pozitivni pol priključimo na $p$ stran, 
negativnega pa na $n$. Takrat pravimo, da smo diodo priključili v prevodni smeri. 
...
Naj bo dioda priključena v prevodni smeri. S priključeno napetostjo spremenimo
potencialno razliko med $p$ in $n$ stranjo in sicer jo 
