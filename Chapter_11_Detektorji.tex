...
pretvorimo v napetost, to pa v digitalni zapis. Pri tem posameznim slikovnim elementom
določimo digitalno vrednost glede na bit-depth globino, 12-bitna recimo vrednosti od 0 do 4095.

full frame ima skoraj cel zaslon ptoobčutljiv, ni mrtvega prostora med piksli. med prenašanjem
podatkov mora biti dostop onemogočen, da ne popači podatkov. Čas zajemanja omejen s prenosom naboja.

manjši pa je del zajema, del pa pretaka in lahko poteka hkrati. Pol pikslov je pokritih, nabira
se v drugih, potem pa pretaka, ko drugi že nabirajo. cs 1 ms je prenos, potem pa lhako počasi 
v miru bere. Je hitra, ampak samo 25procentov svetlobe. No, izmenično eni in drugi. Dodajo leče, 
ki pokrijejo par sensitivie in read out pixlov. Mikroleče, pride do 95 procentov vse sveltobe.
Mikroleče slabost, odziv odvisen od kota vpadnga.
12-bit megapixel, 20 megahertz rate. 

binnig: zmanjša ločljivost, poveča hitrost in zmajša šum. Ali pa krajši čas za isto svetlost
...
slikovnem elementu. Ta način je razmeroma počasen in omejuje hitost zajemanja slike. Odlikuje 
pa jih velika občutljivost na svetlobo in razmeroma nizek šum, ki se ga da s hlajenjem še dodatno 
zmanjšati. počasne.

Ko to število preseže določeno 
vrednost (in se potencialna jama napolni), smo dosegli zgornjo mejo občutljivosti detektorja. 
Več fotonov kot toliko ne moremo zaznati.

piksli lahko uhajajo v sosedno, če preveč polno (presvetlo).

\subsection*{CMOS}
Osnovni element detektorjev CMOS je enak kot za detektorje CCD (slika~\ref{11_MOS}\,b). Bistvena 
razlika je v načinu zajemanja fotoelektronov. Pri detektorjih CCD je bilo branje fotoelektronov
zaporedno, pri detektorjih CMOS pa poteka branje vseh slikovnih elementov hkrati, pri čemer
ima vsak piskel tudi svoj ojačevalnik. Zaradi sprotnega odčitavanja vseh pikslov naenrkat, so
CMOS bistveno hitrejši od CCD. CMOS je ista tehnologija kot mikročipi, cenejši. Bolj dovzetni za 
šum. Cenejši, porabi manj moči
CMOS je uporabljen majši delež piksla, ker ojačevalnik na vsakem posebej. zato manj svetlobe zajema. 
manj očutljivi na svetlobo. 

Večji čum, ker ojačanje poveča šum. Manj občutljine, ne moreš uporabljati leč, ker več plasti. 
ni prelivanja vsaj ne toliko. 

napetost odčitamo na pikslu samem. Hitrejše.manj energije.  šum slabost. manj pretakanja nabojev,
manj potrebne moči. 

cmos, rolling shutter? 


a number of photons hhitting a pixel in exposure time cvreates a number of elekcrons forming a charge
that is converted by capacitor in to volatage amplified digitized resulting in a digital gray value. 

cd high image fidelity , slow; cmos high speed, lower image quality. 
