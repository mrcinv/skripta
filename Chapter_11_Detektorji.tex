...
prevlada predvsem v infrardrečem, teraherčnem ali celo mikrovalovnem območju, kjer drugi 
detektorji ne delujejo. Primeri termičnih detektorjev so bolometer, termočlen in piroelektrični detektor.
...
ni drugih preprostih ali učinkovitih detektorjev. Zato se pogosto uporabljajo tudi v 
astronomiji in za termografske kamere.
...
Vidimo, da moramo za dosego čim krajšega odzivnega časa toplotne izgube kar se da povečati. Če majhne izgube
povečajo občutljivost, pa po drugi strani podaljšajo karakteristični čas $\tau$, 
zato pri termičnih detektorjih ne moremo imeti hkrati močnega in hitrega odziva. 
Če želimo velike toplotne izgube, detektorje hladimo z zrakom ali vodo, majhne toplotne
izgube pa so omejene s sevanjem.  
...
najlepše izračunamo v Fourierevem prostoru. Vpadna moč in temperatura sta tako
\beq
...
občutljivi ($R\sim 100~\si{\volt/\watt}$). So pa robustni, stabilni in delujejo pri sobni 
...
Primerni so za detekcijo teraherčnih valovanj, vendar mora biti za ta namen germanijev
bolometer hlajen s tekočim helijem. Tako lahko dosežemo
...
\begin{figure}[h]
\centering
\includegraphics[width=70truemm]{slike/11_Bolometer.jpg}
...
se uporabljajo kot preprosto dostopni in enostavni infrardeči detektorji, tudi v IR kamerah. 
...
dela kovine. Fotoefekt je prvič opazil Hertz leta 1887, za njegovo razlago leta
1905 pa je Einstein dobil nobelovo nagrado. 
\begin{figure}[h]
\centering
...
Fotocelice so pogosto narejene v cilindrični obliki, pri kateri leži
...
če namesto čistih kovin uporabimo kombinirane bi- ali večalkalne katode,
...
Čas odziva je odvisen od časa preleta elektronov od katode do anode. Da je ta čas čim krajši, 
je napetost na fotocelici pogosto več kV. Tedaj lahko dosežemo zelo kratke odzivne čase, tudi 
do 0,1~ns. Enostavnost in hitrost so torej prednosti fotocelice, njena glavna pomanjkljivost 
pa je majhna občutljivost oziroma nizek kvantni izkoristek. Izkoristek je seveda močno odvisen
od valovne dolžine vpadlega valovanja in snovi, iz katere je katoda. Tipično znaša 
med $10^{-4}$ in $10^{-1}$. Vrednosti so zato tako nizke, ker se izbiti elektroni gibljejo v vse
smeri in se pogosto sipljejo na mreži preden sploh dosežejo površino. 
Za primer vpadne svetlobe z energijo $h\nu = 2$~eV in kvantnega
izkoristka $1~\%$ je občutljivost $R = 5~\si{\milli\ampere/\watt}$. 

Pri vakuumskih fotodiodah pride pri končnih temperaturah tudi do spontane oddaje elektrona, zato 
bo nekaj toka teklo, tudi če je detektor v popolni temi. Ta tok imenujemo temni tok in lahko dosega
vrednosti več nA, odvisno seveda od katode, velikosti detektorja in temperature. Za občutljive
meritve je treba vakuumsko fotodiodo hladiti. 
...
Pomnoževanje se ponovi 8-14 krat, tako da dobimo na en fotoelektron na anodi $10^6 - 10^8$  irena 10e16
...
Kvantni izkoristek je večinoma okoli $30~\%$, razen v bližnjem infrardečem območju, kjer
je znantno manjši. 
