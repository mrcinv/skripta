...
\begin{definition}
Pokaži, da je odziv termičnega detektorja na sunek oblike 
$P(t) = P_0 \delta(t-t_0)$
\begin{equation}
...
Z dopiranjem povečamo območje delovanja detektorja v infrardečem delu. }
...
do daljne infra\-rdečega valovanja.\index{Ultravijolično valovanje}\index{Infrardeče valovanje} 
...
\index{Spoj $p$-$n$}
Ponovimo najprej, kaj se zgodi ob spoju $p$- in $n$- tipa polprevodnika. Pri tem tip $p$ označuje
...
Dodatno se poveča
širina izpraznjenega pasu (naloga~\ref{naloga:depl}), kar zmanjša kapaciteto spoja 
(spoj $p$-$n$ namreč deluje kot neke vrste 
...
saj nizka upornost kovine občutno zmanjša $RC$ konstanto spoja. Odzivni časi dosegajo pikosekundne vrednosti. 
\end{remark}
