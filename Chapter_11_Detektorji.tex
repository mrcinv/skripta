...
in šumom ($N$, {\it noise}) enako $S/N = 1$. \index{Razmerje med signalom in šumom}
\end{enumerate}
...
in negativno nabiti akceptorski atomi na strani $p$, ki povzročijo nastanek  
...
\begin{definition}
Pokaži, da je debelina izpraznjene plasti enaka $d = d_n+d_p$,
kjer sta
\beq
d_{n,p}= \sqrt{\frac{2\varepsilon_0(\Delta\Phi-V)}{e_0}\frac{(N_a/N_d)^{\pm 1}}{N_a+N_d}},
\eeq
kjer $N_a$ in $N_p$ označujeta gostoti akceptorskih in donorskih atomov, **
...
S tem se efektivno bistveno poveča območje
