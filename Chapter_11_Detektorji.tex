...
tako imenovano dinodo, iz katere izbije več ($\sim 5 - 40$) sekundarnih elektronov. Ti elektroni
potujejo do naslednje dinode, ki je pod višjo pozitivno napetostjo, in ponovno izbijejo elektrone, 
ki vpadejo na naslednjo dinodo ... To pomnoževanje se večkrat ponovi 
in na vpadli foton lahko dobimo $10^9$ elektronov na anodi. 
Fotopomnoževalka tako omogoča štetje posameznih fotonov. 
\begin{figure}[h]
\centering
...
Odzivni čas fotopomnoževalke je odvisen od notranje postavitve dinod. Ker posamezni elektroni
do anode potujejo različno dolgo, je sunek na izhodu vedno razširjen, tipično okoli $\sim 0,1-20~
\si{\nano\second}$.
...
tako fotocelice kot fotopomnoževalke je odvisna od sestave površine fotokatode. 
