...
\caption{Frekvenčna odvisnost ojačenja (rdeča črta) z označenim pragom ojačenja (modra črta) 
ter lastne frekvence resonatorja (črne črte) (a). Z rdečo so označene tiste lastne frekvence, ki se 
v laserju ojačujejo. Ko dodamo Fabry-Perotov interferometer s dano prepustnostjo (b), povečamo
izgube za vse načine, ki so sicer ojačani, razen za enega. Tako dosežemo delovanje laserja
pri eni sami frekvenci (c).}
\label{fig:FPmodes}
\end{figure}
