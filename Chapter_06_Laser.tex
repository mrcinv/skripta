...
zožanja spektralne črte je zato aktivna stabilizacija
...
natančneje kot dolžino resonatorja, v katerem imamo aktivno sredstvo, ki mu 
...
iodove pare. Povprečna moč laserja naj bo $P_0 = 10~\si{mW}$ in $P_1= 0,1~\si{mW}$. 
...
sunki, dolgi $\tau = 1/\Delta \nu = 10~\si{fs}$, med posameznima sunkoma 
...
pri šibkejših sunkovnih laserjih, na primer pri Nd:YAG laserjih.\index{Laser!Nd:YAG}
\begin{figure}[h]
\centering
...
pojavita še stranska pasova pri frekvencah $(\omega_0 + m\Delta \omega) \pm \Delta\omega$. Ta
...
gostoti pa svetlobo prepušča, saj pride do nasičenja absorpcije (glej\index{Nasičena absorpcija}
...
Iz fazno uklenjenega laserja izhajajajo zelo kratki sunki svetlobe, ki 
so sestavljeni iz velikega števila vzbujenih lastnih nihanj. Spekter 
izhodne svetlobe je tako sestavljen iz velikega števila spektralnih črt, ki
so med seboj enakomerno razmaknjene (slika~\ref{fig:comb}). Zaradi podobnosti spektra
z glavnikom imenujemo tak izvor svetlobe frekvenčni glavnik. 
Spekter frekvenčnega glavnika je zelo natačno določen in uporabljamo ga za 
izredno natančno merjenje frekvence svetlobe. Ko svetloba z neznano frekvenco
interferira s svetlobo iz frekvenčnega glavnika, pride do interferenčnih pojavov.
Zaradi majhnih razlik v frekvecah pride do pojava utripanja s frekvenco v 
radijskem območju, ki jo znamo zelo natančno izmeriti in tako določiti neznano 
vpadno frekvenco.\footnote{Za odkritje sta John L. Hall in Theodor W. H\"ansch 
leta 2005 prejela Nobelovo nagrado.} 
\begin{figure}[h]
\centering
\def\svgwidth{120truemm} 
...
Na splošno se krožne frekvence izhodne svetlobe zapišejo kot
\begin{equation}
\omega = \omega_0 + m\Delta \omega,
\end{equation}
pri čemer je $m$ naravno število. Glavna težava pri izvedbi frekvenčnega glavnika
je stabilizacija $\omega_0$ in $\Delta\omega$.

stabilizacija envelope-faze z nelinearnim interferometrom. razmik se preprosto
stabilizira, saj je v ombočju MHz in GHz. Z f2f interferometrom je pa tudi absolutna
lega glavnika določena- S primerjavo z atomsko uro... se obe količini točno določita.

Če je obseg več kot oktava (se pravi faktor dva), potem lahko direktno merimo f0.
carrier-envelope phase se popravlja s feedbackom. 

Najpomembnejše odkritje je stabilizacija carrier envelope offset frewquency. 


V prejšnjem razdelku smo privzeli, da se frekvence vzbujenih lastnih 
nihanj med seboj razlikujejo za večkratnik razlike $\Delta \omega = \pi c/L$. 

To je v teoriji. Lahko imamo disperzijo grupne hitrosti, potem se delta omega
malo spreminja z omego. 
