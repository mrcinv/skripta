...
Zapisali bomo zasedbene enačbe in razložili delovanje laserjev, opisali načine
delovanja laserjev v sunkih in spoznali nekaj zanimivih pojavov, ki so posledica
lastnosti laserske svetlobe.

\section{Laser}
\index{Laser}
Spoznali smo, da se svetloba pri prehodu skozi sredstvo z obrnjeno zasedenostjo
med dvema nivojema ojačuje. Zdaj pa postavimo tako sredstvo v optični resonator. 
...
da se svetloba dovolj ojača in tako stimulirano sevanje prevlada nad spontanim. 
...
(\ref{5.7}) in (\ref{5.8}). V splošnem je treba zapisan sistem diferencialnih
...
Poglejmo primer. Močen zvezno delujoč laser ima izhodno moč $10~\si{kW}$.
...
dosežemo moči, ki so za $5$--$10$ velikostnih redov večje od zvezno delujočih
laserjev. 

V grobem poznamo dva načina sunkovnega delovanja laserjev. V prvem primeru
...
\caption{Delovanje sunkovnega laserja z moduliranim črpanjem, pri katerem
...
parcialnih diferencialnih enačb pa je na splošno zelo težavno.
