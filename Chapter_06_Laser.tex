...
\begin{equation}  
\label{5.64}
\frac{d P_\lambda^+}{dt}=\left(-i \omega_0-\gamma\right)P^{+}+\frac{iv_{12}^2}{\hbar} E_\lambda^+ \overline{Z}.
\end{equation}
...
\begin{equation}  
\label{5.66}
\frac{d\overline{Z}}{dt}= A\left(\overline{Z}_0-\overline{Z}\right)- \frac{2}{i\hbar}\left(E_{\lambda}^+
...
A\left(\overline{Z}_{0}-\overline{Z}\right)-\frac{2}{i\hbar }\,E_{0}\left(P_{0}^{*}-P_{0}\right) &=&0.
\end{eqnarray}
