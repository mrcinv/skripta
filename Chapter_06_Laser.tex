...
$10^{-18}~\si{Hz}$.\footnote{Za odkritje 
...
definiran kot $1\,650\, 763,73$ valovnih dožin svetlobe, ki jo izseva kriptonov
...
da imamo tudi od nič različno polarizacijo snovi. 
...
\begin{equation}  
\label{5.68}
\overline{Z}=\overline{Z}_0\left(1+\frac{V^2}{\hbar^2 A}\,E_0^2\, \frac{2\gamma}
{\left(\omega_0-\Omega\right)^2+\gamma^2}\right)^{-1}.
\end{equation}
Ta izraz že poznamo. $\pi V^2/\left(\epsilon_0\hbar^2\right)$ je Einsteinov
...
+\gamma]=-\frac{V^2 \omega_0}{2\hbar\epsilon_0}\,E_0\,\overline{Z}\;.
\end{equation}
