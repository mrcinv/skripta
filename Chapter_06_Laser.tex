...
\caption{Frekvenčna odvisnost ojačenja z označenim pragom ojačenja (a), 
lastne frekvence resonatorja (b) in frekvence, ki se v takem resonatorju ojačajo (c). 
Ko dodamo Fabry-Perotov interferometer s dano prepustnostjo (d), dosežemo
delovanje pri eni sami frekvenci (e).}
\label{fig:FPmodes}
\end{figure}
