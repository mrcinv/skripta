...
\subsection*{Mehanizem delovanja}
...
prepovedani pasovi oziroma energijske reže. Tipična energijska
...
imata vrh prevodnega pasu v centru Brilluinove cone pri valovnem
...
primer GaAs, kjer je valenčni pas $1,4~\si{eV}$ nad prevodnim. 
...
in znašajo, na primer v GaAs, $m_p^* = 0,067~m_e$ in $m_v^* = 0,55~m_e$. 
Gostota stanj za vrzeli je v tem primeru znatno večja kot gostota stanj za elektrone.

Verjetnost za zasedenost elektronskih stanj je podana s Fermi-Diracovo funkcijo 
\begin{equation}  
f(E)=\frac{1}{e^{(E-E_F)/k_B T}+1},
\label{eq:7FD}
\end{equation}
kjer $E_F$ označuje Fermijevo energijo. Spomnimo, da so pri $T=0$ vsa stanja pod
Fermijevo energijo zasedena, nad njo pa prazna. V čistem polprevodniku je $E_F$ 
na sredini med valenčnim in prevodnim pasom, z dodajanjem donorskih primesi (tip $n$) 
pa se verjetnost, da elektroni zasedajo prevodni pas, povečuje in Fermijeva energija
se približuje prevodnemu pasu. 
