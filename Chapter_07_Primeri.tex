...
Za črpanje z električnim tokom so potrebne le zelo majhne jakosti oziroma
nizke napetosti (tipično $15~\si{\milli\ampere}$ pri $2~\si{\volt}$), 
...
Pri polprevodniških laserjih je mehanizem delovanja drugačen od do zdaj obravnavanih
laserjev, zato si ga podrobneje oglejmo. Pri običajnih laserjih so elektroni
...
prepovedani pasovi oziroma energijske reže (slika~\ref{fig:Ek}). Tipična energijska
reža v polprevodnikih med prevodnim in valenčnim pasom je $\lesssim 2~\si{eV}$, 
zato je že pri sobni temperaturi prevodni pas deloma zaseden, v valenčnem pasu
pa se pojavijo vrzeli. Osnova, ki vodi do izsevane svetlobe v polprevodnikih, 
je prehod elektrona iz prevodnega v valenčni pas, pri čemer izseva foton.

Polprevodniki absorbirajo svetlobo s frekvenco, ki je enaka ali večja od širine
reže med valenčnim in prevodnim pasom. Pri tem z vzbuditvijo elektrona iz valenčnega v
...
ali InP, kjer je širina reže  $1,34~\si{eV}$.
Z ustrezno izbiro elementov delujejo polprevodniški laserji v območju 
valovnih dolžin od $\sim 400~\si{nm}$ do več $\si{\micro\meter}$. 

V najpreprostejši sliki energijske pasove v polprevodniku opišemo s parabolično 
odvisnostjo od valovnega vektorja $\mathbf{k}$
\beq
E = \frac{\hbar^2 k^2}{2m^*}.
\eeq
Pri tem $m^*$ označuje efektivno maso v prevodnem ali valenčnem pasu, ki 
jo izračunamo kot
\beq
...
in znašata, na primer v GaAs, $m_p^* = 0,067~m_e$ in $m_v^* = 0,5~m_e$. 
Gostota stanj za vrzeli je v tem primeru znatno večja kot gostota stanj za elektrone.
...
V čistem polprevodniku je $E_F$ tako na sredini med valenčnim in prevodnim pasom.
...
\label{6.3a}
\eeq
Podobno zapišemo tudi izraz za število vrzeli v valenčnem pasu na enoto prostornine
\beq
...
imamo veliko populacijo elektronov v pravodnem in veliko populacijo vrzeli v valenčnem pasu. 
Zato za opis ni več dobra Fermijeva funkcija. Zato Fermijeva funkcija
ni dobra za opis in uporabimo koncept kvazi-Fermijevega nivoja Fn in Fp.
kvazi fermijev nivo opisuje porazdelitev nosilcev naboja znotraj svojega pasu.
kvazi fermij elektronov je 
...
Forward bias naredi Fermijeva nivoja različna in Efn je večji od EFp. Razlika narašča
kot funkcija toka, ki teče skozi stik. Če je razlika večja od gapa, oziroma
bolj natančno 
\beq
E_{Fn}-E_{Fp} \geq h \ni \geq E_g.
\eeq

Ta enačba je ekvivalentna pogoju za obrnjeno zasedenost v navadnih laserjih. 
