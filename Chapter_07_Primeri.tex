...
preprosta izdelava, velik izkoristek ($\sim 50~\%$), 
predvsem pa neposredno črpanje z električnim tokom.
Za črpanje zadoščajo že majhni tokovi oziroma nizke napetosti 
(tipično $15~\si{\milli\ampere}$ pri $2~\si{\volt}$), 
kar omogoča zelo hitro modulacijo svetlobne moči z modulacijo 
električnega toka. Njihova slabost je razmeroma širok spekter in posledično
majhna koherenca. Polprevodniški laserji delujejo v območju 
valovnih dolžin od $\sim 400~\si{nm}$ do več $\si{\micro\meter}$. 
...
prepovedani pasovi oziroma energijske reže (slika~\ref{fig:Ek}). 
Rekombinacija elektronov iz prevodnega pasu z vrzelmi iz valenčnega pasu,
pri kateri se izseva foton, je osnova za delovanje polprevodniškega laserja. 

Polprevodniki absorbirajo svetlobo s frekvenco, ki je enaka ali večja od širine
reže med valenčnim in prevodnim pasom. Z vzbuditvijo elektrona iz valenčnega v
...
majhen v primerjavi z vektorjem recipročne mreže polprevodniškega kristala.
To ima pomembno posledico. Najobičajnejša polprevodnika, silicij in germanij,
imata vrh prevodnega pasu v centru Brillouinove cone pri valovnem
vektorju $\mathbf{k}=0$, dno prevodnega pasu pa pri $\mathbf{k} \neq 0$.
Direkten direkten prehod z dna prevodnega pasu v vrh valenčnega pasu z
izsevanjem fotona zato ni možen, priti mora  še do emisije ali absorpcije
fonona, ki poskrbi za ohranitev gibalne količine. Tak proces je mnogo 
manj verjeten, zato v siliciju in germaniju v običajni obliki ni
...
primer GaAs, kjer je valenčni pas $1,42~\si{eV}$ nad prevodnim,
ali InP, v katerem je širina reže  $1,34~\si{eV}$.
...
pas, modra pa valenčni. Prehod preko direktne reže (levo) je veliko bolj 
verjeten kot prehod preko indirektne reže (desno), saj mora priti še do emisije
ali absorpcije fonona. 
}
\label{fig:Ek}
\end{figure}
...
interakcije in se zato razlikuje od navadne mase $m_0$.
Podobno z efektivno maso vrzeli zapišemo energijo valenčnega pasu
\beq
E_v = - \frac{\hbar^2 k^2}{2m_v}.
\label{pp:Ev}
\eeq
V termičnem ravnovesju je se na dnu prevodnega pasu nahajajo termično 
vzbujeni elektroni, na vrhu valenčnega pasu pa vrzeli. Gostoto stanj za
prevodni in valenčni pas zapišemo kot
\beq
...
\label{eq:rho_p}
\eeq
Vidimo, da je edini parameter, ki nastopa v izrazu za gostoto stanj, efektivna
masa elektronov oziroma vrzeli. Ti dve masi sta značilni za posamezen polprevodnik
...
Verjetnost za zasedenost elektronskih stanj je zaradi Paulijevega izključitvenega
...
Fermijevo energijo zasedena, nad njo pa prazna. V splošnem določa Fermijeva
energija tisto vrednost, pri kateri je verjetnost za zasedenost stanja $1/2$.
Ustrezna verjetnost za pojav vrzeli v  valenčnem pasu je $f_v = 1 - f_e$.
...
\eeq
\begin{remark}
Iz pogoja, da je število elektronovov v prevodnem pasu enako številu vrzeli v 
valenčnem pasu, se lahko določi $E_F$. Zaradi razlike v efektivnih masah Fermijeva
energija ni povsem na sredini med valenčnim in prevodnim pasom, ampak je 
premaknjena proti pasu z manjšo efektivno maso. 
\end{remark}
...
\eeq
Število elektronov v prevodnem pasu (in vrzeli v valenčnem) je tudi pri končnih 
temperaturah razmeroma nizko. Ga pa lahko znatno povečamo, če povišamo Fermijevo energijo.

To dosežemo z dopiranjem, nadzorovanim uvajanjem nečistoč. Če dodamo donorske primesi,
to so take, ki povečajo število elektronov, govorimo o polprevodniku tipa $n$, 
če pa dodajamo akceptorske snovi, torej take, ki elektrone vežejo nase, pa govorimo
o polprevodniku tipa $p$. Primeri donorskih snovi za GaAs so žveplo, selen ali telur,
primer akceptorskih snovi pa cink in kadmij. Zaradi dodanih snovi se v energijski 
reži pojavita nova energijska nivoja. Donorski nivo je tipično tik pod prevodnim 
pasom, Fermijeva energija se premakne navzgor in že pri sobni temperaturi dosežemo 
veliko število elektronov v prevodnem pasu. 
Podobno je v tipu $p$ akceptorski pas tik nad valenčnim, Fermijeva
energija se pomakne navzdol in število vrzeli v valenčnem pasu naraste. 

Da dosežemo znatno število rekombinacij elektronov in vrzeli (in torej znatno
število izstopnih fotonov), moramo v istem delu vzorca doseči veliko koncentracijo
obeh nosilcev naboja. To naredimo s stikom $p-n$.

\subsection{Stik $\mathit{p}$-$\mathit{n}$}
Najpreprostejši primer je stik $p$-$n$, pri katerem staknemo dva kosa iste 
snovi, le da je na eni strani ta snov dopirana z akceptorji in na drugi z donorji.
Ko staknemo območji $p$ in $n$, elektroni iz prevodnega pasu $n$ strani difundirajo 
na stran $p$, vrzeli pa ravno obratno. V stacionarnem stanju nastane ozek pas, 
tako imenovani, izpraznjeni sloj, v katerem ni prostih nosilcev naboja. Na strani $n$
ostanejo pozitivni donorski ioni, na strani $p$ pa negativni akceptorski ioni strani, ki 
ustvarjajo električno polje. Nastalo polje preprečuje nadaljnjo difuzijo nosilcev 
naboja. V ravnovesju se Fermijeva energija na obeh straneh izenači, prevodni 
in valenčni pas pa se ukrivita. 

Ko skozi stik sreče tok v prevodni smeri (to je od $p$ proti $n$), se potencialni
skok zmanjša in prosti elektroni iz prevodnega pasu difundirajo na stran $p$, 
vrzeli iz valenčnega pasu pa na stran $n$. Zaradi razlike v efektivni masi je mobilnost
elektronov veliko večja od vrzeli, zato gre več elektronov na p stran kot vrzeli na n.
Zdaj imamo na p strani veliko dodatnih elektronov. Dokler ne pride do rekombinacije,
imamo veliko populacijo elektronov v prevodnem in veliko populacijo vrzeli v valenčnem pasu. 
Fermijeva funkcija ni več dobra za opis zasedenosti stanj in uporabimo koncept 
kvazi-Fermijevega nivoja $F_n$ in $F_p$, ki opisujeta verjetnost zasedenosti posebej
za valenčni in prevodni pas. $F_{p}$ je odvisna od toka skozi spoj in od 
temperature, kar je pomebno za delovanje polvodniškega laserja.

Forward bias naredi Fermijeva nivoja različna in Efn je večji od EFp. 
\begin{remark}
Tak približek je dober, kadar je čas, v katerem 
preidejo vzbujeni elektroni z višjih energij na dno prevodnega pasu, dosti krajši 
od časa prehoda iz prevodnega v valenčni pas. Ta pogoj je v polvodnikih, ki jih 
uporabljamo za laserje, navadno zelo dobro izpoljnen. Preko trkov s fononi elektroni 
preidejo v dno prevodenga pasu v pikosekundah, za prehod v valenčni pas, to je za
rekombinacijo elektrona z vrzeljo, pa so potrebne nanosekunde.
\end{remark}

Naj na stik $p$-$n$ vpada svetloba z energijo fotonov $\hbar \omega$, ki je nekoliko
nad $E_g$. Svetloba povzroča prehode med stanji z energijo $E_p$ v prevodnem pasu 
in med stanji z energijo $E_v$ v valenčnem pasu, kot kaže slika~(\ref{s6.11}).

\begin{figure}[h]
\centering
\def\svgwidth{120truemm} 
%\input{slike/07_Ek.pdf_tex}
\caption{Ob absorpciji fotona pride do prehoda elektrona iz valenčnega v prevodni
pas in nastanka vrzeli v valenčnem pasu. 
}
\label{s6.11}
\end{figure}

V splošnem se ta stanja lahko razlikujejo po valovnem vektorju, zato
moramo verjetnost za stimuliran prehod najprej zapisati za določen valovni
vektor $\mathbf{k}$, nato pa sešteti po vseh možnih $\mathbf{k}$. Uporabimo 
Fermijevo zlato pravilo za verjetnost za prehod med dvema stanjema v časovni
enoti, vendar upoštevamo, da je verjetnost za zasedenost gornjega stanja $f_p(E_p)$ in verjetnost, da je
spodnje stanje nezasedeno, $1-f_v(E_v)$. Zapišemo
\begin{equation}  
...
\begin{equation}  
E_p-E_v= E_g + \frac{\hbar^2 k^2}{2}(\frac{1}{m_p}+ \frac{1}{m_v})= E_g + \frac{\hbar^2 k^2}{2m_r},
\label{6.8}
\end{equation}
...
spontanih emisij in absorpcij na enoto volumna potem zapišemo 
\begin{eqnarray}  
N_{pv}-N_{vp}&=&\int\left(w_s-w_a\right)\rho(k)\,dk  \nonumber \\
&=&\frac{2}{\pi\hbar} \int |H_{pv}|^2\left(f_p(E_p)-f_v(E_v)\right)
...
\int |H_{pv}|^2 \left(f_p(E_p)-f_v(E_v)\right)
...
\begin{equation}  
N_{pv}-N_{vp}=\frac{1}{\pi\hbar}\left(\frac{2m_r}{\hbar^2}\right)^{3/2}
\sqrt{\hbar \omega-E_g}\left(f_p(E_p)-f_v(E_v)\right),
\label{6.11}
\end{equation}
kjer je $E_p-E_v = \hbar \omega$. 

Poglejmo rezultat podrobneje. Da v polprevodniku pride do ojačenja 
vpadne svetlobe in ne njene absorpcije, mora biti gornji izraz pozitiven in 
\begin{equation}  
...
\label{6.13}
\end{equation}
Dodali smo pogoj, da se lahko ojačujejo le tiste frekvence, ki so 
nad energijsko režo $E_g$ in pod razliko kvazi-Fermijevih energij 
za oba pasova. Ta enačba je ekvivalentna pogoju za obrnjeno zasedenost 
v navadnih laserjih. Ojačenje kot funkcijo frekvence kaže slika~(\ref{s6.12}).
\begin{figure}[h]
\centering
\def\svgwidth{120truemm} 
%\input{slike/07_Ek.pdf_tex}
\caption{Nimam pojma, kakšna slika. 
}
\label{s6.11}
\end{figure}

Ojačenje vpadne svetlobe pri dani frekvenci $\omega$ zapišemo kot
\beq
\gamma(\omega) = K \sqrt{\hbar \omega - E_g}\left(f_p(E_p)-f_v(E_v)\right).
\eeq

Razlika narašča z naraščajočim tokom, ki teče skozi stik. POvečanje
temperature pa razširi območje prehoda Fermijevih funkcij in zato zmanjša 
ojačenje. 
...
ACTIVE REGION. DEGENERATE P AND N: FERMIJEVA ENERGIJA JE NAD GAPOM, PRI 
T=0 SO ZASEDENA STANJA V PREVODNEM PASU. 

Prvi laserji v degeneriranih pn stikih. Pri velikih tokov je območje blizu
izpraznjenega območja, v katerem so hkrati degenerirani polpulaciji elektronom
vin vrzeli. Če ni toka li aso majhnni, Fp-Fv večji od homega ni izpolnjen
 in ni ojačenja. Če je prikljuičena napetost približno ena a gapu, obstoja
 aktivno občjue, ki ima degenerirani obe populaciji. Valovenje pri omega
 se ojačuje. 
 Debelina aktivne plasti je dolžina, kijo preporujejo jo elektroni, ki
 so inketirani v p regijo, naredijo, predden se rekombinirajo. to je 100 mikronov.
 
 Skica preprostega pn laserja. 
...
V izpraznjenem območju
se pojavi velika koncentracija elektronov in vrzeli, kar vodi do velikega števila
rekombinacij. Dioda oddaja svetlobo pri valovni dolžini okoli reže. Pri nizkih
tokovih pride so spontane rekombinacije. Pri velikih koncentracijah nosilcev
naboja pa pride do stimuliranih rekmbinacij, ki omogočajo optično ojačenje. 

ko v forward smeri, elektroni z n strani so injektirani v vmesno območje, kjer soobstojajo
z vrzelmi, ki so injektirane iz p stgrani. Pride do rekombinacije s spontano ali
stimulirano emisijo. Da dosežemo ojačanje, mora forward voltage preseči širino reže. 
...
Prvi polprevodniški laser je deloval leta 1962, GaAs, oddaja pri 850 nm. Osnovna zgradba:
active region je izpraznjena plast dolžine 200-500 mikronov in 100-200 mikronod širine.
debelina je tipično zelo majhna, okoli 1 mikron. je homojunction laser.  Homostik. PREVOD?

laser je navadno resonator med dvema končnima strenama kristala polprevodnika. 
Lomni količnik npr gaas 3,5, kar da odbojnost 0,3. in niti ne rabijo posebnega coatinga čez.

GaAs je deloval pri 77K. Če povečaš temperaturo, več elektronov zasede stanje nad Fermijevo
energijo in optično ojačenje se zmanjša. Naraste prag delovanja, ki je pa tako velik, da ga
skurimo. Slabost je tudi, da je velikost žarka v s meri veliko večja od debeline aktivnega 
območja. Posledično veliko svetlobe potuje po p in n območju, kjer se absorbira. 
Drug problem je hiter drift nosilcev naboja ven iz izpraznjege območja, zato je le del 
na voljo za stimulirano emisijo.

Heterostrukture.

Bistveno izboljšano delovanje. P in N stran sta narejena iz različne snovi. To odkritje leta 1970
Alferov in Kroemer, ki sta dobila Nobelovo nagrado leta 2000. Tipično, recimo
$p-Ga_{1-x}Al_xAs p GaAs n-Ga_{1-x}Al_xAs$, na podlagi od n GaAs.Tipično je x 0,3
