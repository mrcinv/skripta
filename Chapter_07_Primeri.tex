...
Oglejmo si zato energijske pasove in prehode med njimi podrobneje.  
...
verjeten kot prehod preko indirektne reže (desno), saj mora zaradi ohranitve
gibalne količine priti še do emisije ali absorpcije fonona. 
}
\label{fig:Ek}
\end{figure}
...
elektrone vežejo nase, pa govorimo o polprevodniku tipa $p$. 
Primeri donorskih snovi za GaAs so žveplo, selen ali telur,
primer akceptorskih snovi pa cink in kadmij. Zaradi dodanih snovi se v energijski 
reži pojavita nova energijska nivoja. Donorski nivo je navadno tik pod prevodnim 
...
Podobno je v tipu $p$, v katerem se Fermijeva energija pomakne navzdol -- lahko 
tudi v valenčni pas -- in število vrzeli v valenčnem pasu močno naraste. 

\subsection{Ojačenje v polprevodnikih}
Ko elektrone vzbudimo iz valenčnega v prevodni pas, se v valenčnem pasu pojavijo
ustrezne vrzeli. Dokler ne pride do rekombinacije (tipično je to nekaj $\si{ns}$),
je v prevodnem pasu ustvarjeno kvazi-termično ravnovesje, saj je relaksacija 
...
valenčnem pasu Fermijeva funkcija ni več dobra za opis zasedenosti stanj. Uporabimo
...
enaka nič, z naraščajočim vzbujanjem pa se razlika povečuje (slika~\ref{fig:QF}\,a).
\begin{figure}[h]
\centering
\def\svgwidth{120truemm} 
\input{slike/07_QFE.pdf_tex}
\caption{V vzbujenem stanju so zasedena najnižja mesta v prevodnem pasu in 
izpraznjena najvišja mesta valenčnega pasu (a). Za vsak pas posebej vpeljemo
Fermijevo energijo $F_p$ in $F_v$. 
}
\label{fig:QF}
\end{figure}

Posvetimo zdaj na polprevodnik s svetlobo s frekvenco $\omega$.
Vpadna svetloba povzroča prehode med stanji z energijo $E_a$ v valenčnem 
in med stanji z energijo $E_b$ v prevodnem pasu (slika~\ref{fig:QF}\,b).
...
enoti, vendar upoštevamo, da je verjetnost za zasedenost gornjega stanja 
$f_p(E_p)$ in verjetnost, da je spodnje stanje nezasedeno, $1-f_v(E_v)$. Zapišemo
\begin{equation}  
...
Zdaj imamo na p strani veliko dodatnih elektronov. 
...
reže med valenčnim in prevodnim pasom. 
Ta se lahko rekombinira z
