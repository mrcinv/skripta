...
lomnega količnika lahko valovanju spreminjamo amplitudo\index{Modulacija!amplitudna} 
ali frekvenco oziroma fazo\index{Modulacija!frekvenčna}\index{Modulacija!fazna}. 
\begin{figure}[h]
\centering
...
\eeq
Izračunajmo zvezo med majhnimi spremembami inverznega tenzorja $\delta b_{ij}$ 
in majhnimi spremembami dielektričnega tenzorja $\delta \varepsilon_{ij}$. 
...
\eeq
oziroma, če je nemoten dielektrični tenzor $\underline{\tilde{\varepsilon}}$ diagonalen, 
\begin{equation}
...
Po definiciji je Pockelsov tenzor simetričen v prvih dveh indeksih
\beq
r_{ijk} = r_{jik}.
\eeq
...
$6\times3$, simetrični tenzor drugega ranga $b_{ij}$ pa šestkomponenten
vektor.

Za primer poglejmo, kako štirištevna simetrijska os zmanjša število komponent. 
Simetrijska os naj bo obrnjena v smeri $z$, zato morajo zasuki okoli te osi 
za večkratnik $\pi/2$ dati isti rezultat. Za drugimi besedami, če priključimo
polje v $x$ ali v $y$ smeri, mora biti sprememba tenzorja enaka
\beq
...
električno polje pa naj bo vzporedno z njo.
Rotacija za $\pi/2$ okoli osi $z$ je simetrijska operacija in prevede
os $x$ v $y$, zato mora biti 
\beq
r_{xxz}=r_{yyz}.
\eeq
Nadalje poglejmo zvezo 
\begin{equation}
