...
\begin{definition}
Yariv 442, izračunaj lastne osi in lastne lomne količnike če longitudinalen zvok v smeri z.
\end{definition}

Podobno kot pri elektro-optičnem pojavu lahko iz enačbe~(\ref{7.27}) izrazimo
spremembo dielektričnega tenzorja 
\begin{equation}
\delta\epsilon_{ij}=-\tilde{\epsilon}_{ii}\tilde{\epsilon}_{jj}p_{ijkl}S_{kl},\label{7.29}
\end{equation}
...
Vzbudimo v plasti prozorne snovi zvočno valovanje z valovno dolžino $\Lambda$.
...
\beq
n = n_0 + \Delta n \sin \left(\frac{2\pi}{\Lambda} z- \Omega t\right).
\eeq
...
\begin{remark}
Velika prednost dobljene uklonske mrežice je njena dinamičnost. To pomeni, da jo lahko 
s spreminjanjem zvočnega vala zelo hitro spreminjamo in s tem spreminjamo smer uklonskega žarka.
S kombinacijo dveh med seboj pravokotnih akusto-optičnih modulatorjev lahko žarek zelo hitro
premikamo po ravnini. Akusto-optični modulatorji so zato nepogrešljivi pri hitrem in 
...
zvočno valovanje, primerljiva z valovno dolžino $\Lambda$. Takrat modulator deluje 
...
V nasprotnem primeru deluje modulator kot debela uklonska mrežica. 
Takrat se pojavi zgolj en uklonjen žarek, vendar le ob izpolnjenem Braggovem 
pogoju\footnote{Angleška znanstvenika in nobelova nagrajenca Sir William Henry Bragg, 1862--1942,
in Sir William Lawrence Bragg, 1890--1971.}
\begin{equation}
2 \Lambda\sin\theta=\pm N\lambda.
\label{7.29}
\end{equation}
V tem primeru je izhodni kot enak vpadnemu kotu $\theta$. Celoten kot, za katerega se ukloni
žarek, pa je enak $\theta = 2 \vartheta$.
