...
\end{array}\right],
\end{equation}
pri čemer so $n_1$, $n_2$ in $n_3$ lomni količniki snovi, ki so na splošno različni. 
...
svetloba po preletu kristala na splošno eliptično polarizirana. 
...
Na splošno je iskanje rešitev gornje enačbe zapleten problem, vendar 
