...
je dolžina grla $2z_0 = 2 \pi w^2/\lambda$ (enačba~\ref{eq:z0}). Največja dolžina poti, pri 
...
v katerem je vzbujeno zvočno valovanje s krožno frekvenco $\Omega = 150~\si{\mega\hertz}$ in
