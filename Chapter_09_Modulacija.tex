...
ki odražajo različne stopnje urejenosti. Omejimo se najosnovnejši
...
\caption{Molekula enega najbolj razširjenih tekočih kristalov, 4-ciano-4'pentilbifenila ali 5CB
(levo) in shematski prikaz nematične faze (desno).}
\label{fig:5CB}
\end{figure}

Molekule so v nematični fazi v povprečju urejene, zato se nematični tekoči kristal
...
nehonogenosti $\mathbf{n}$. 

V makroskopskem vzorcu nematičnega tekočega kristala se v splošnem smer
direktorja $\mathbf{n}$ po vzorcu neurejeno spreminja. Energija Temu pojavu, značilnemu za tekoče kristale,
