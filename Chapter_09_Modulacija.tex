...
Vzbudimo v plasti prozorne snovi stoječe zvočno valovanje z valovno dolžino $\Lambda$.
...
na drugo stran pa akustični reflektor.
Zaradi stoječega valovanja se v snovi periodično spreminja gostota in z njo lomni količnik
\beq
...
valovne dolžine stoječega valovanja - zvoka. Zvočno valovanje v snovi torej deluje kot 
optična fazna mrežica. Tipična frekvenca, s katero vzbujamo elastično
deformacijo, je okoli $\Omega=50$~MHz, ustrezna valovna dolžina pa okoli $100~\mu$m. 
SLIKA

Oglejmo si dva limitna primera. V prvem primeru je debelina snovi $d$, v kateri vzbujamo
zvočno valovanje, tanka v primerjavi z valovno dolžino $\Lambda$. Takrat modular deluje 
kot tanka uklonska mrežica in pojavi se veliko uklonskih vrhov.
SLIKA
...
V veliki oddaljenosti od plasti bomo poleg osnovnega snopa dobili še uklonjene
