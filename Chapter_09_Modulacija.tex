...
zasučemo za kot 90$^{o}$ eno glede na drugo (slika~\ref{LCD1}\,a), zato se $\mathbf{n}$ 
...
osi, ki se obrne pravokotno na plast tekočega kristala (slika~\ref{LCD1}\,b). V tem primeru 
...
zasučejo. Polarizacija svetlobe (P) se ohranja in analizator (A) 
je ne prepusti. }
\label{LCD1}
\end{figure}
...
Prikazovalniki, ki delujejo z odbito svetlobo (npr. žepna računala), 
imajo za zadnjim analizatorjem odbojno površino. Svetloba tako dvakrat 
prepotuje tekočekristalno celico. Večina prikazovalnikov (npr. računalniški 
ali telefonski zasloni) pa uporablja osvetlitev z LED 
ali fluorescenčnimi svetili. 
...
\caption{Kvalitatitvno obnašanje amplitude deformacije ob Frederiksovem prehodu}
\label{Fred}
\end{figure}

\begin{definition}
Izračunaj Frederiksov prehod v zasukani nematski celici (kot zasuka med zgornjo in spodnjo 
naj bo $\pi/2$) in pokaži, da je kritično polje za prehod enako
\beq
E_c =  \frac{\pi}{d}\sqrt{\frac{K_1}{\varepsilon_0\varepsilon_a}}
