...
sta planarna ureditev (levo), kjer je direktor vzporeden s plastjo snovi, in 
homeotropna ureditev (desno), kjer je direktor pravokoten na plast snovi.}
\label{s7.20a}
\end{figure}
...
\centering
\def\svgwidth{50truemm} 
%\input{slike/09_LCD1.pdf_tex}\qquad
\def\svgwidth{54truemm} 
%\input{slike/09_LCD2.pdf_tex}
\caption{Preklop zasukanega nematika}
\label{LCD2}
\end{figure}
...
\epsilon_{0}\epsilon_{a}(n_{z}E)^{2}\right]dz=\nonumber \\
 & = & \frac{1}{2}\int_{0}^{d}
 [K_{1}q^{2}a^{2}\cos^{2}qz+K_{3}q^{2}a^{4}\sin^{2}qz\cos^2qz-
...
saj smo pri računu privzeli, da je $n_{z}\ll1$. Prehodu iz nedefromiranega
