...
\begin{definition}
Pokaži, da je v kristalih s centrom inverzije tenzor $\underline{r}$
vedno enak nič. 
\end{definition}
...
\end{align}
\index{Dvolomnost!dvoosne snovi}
Kako pa je z novimi lastnimi osmi? Hitro ugotovimo (enačba~\ref{7.8b}), da se pri 
...
Naslednja pomembna uporaba je za uklepanje faz\index{Uklepanje faz}
...
obstajajo pri vseh frekvencah, razen v ozkem območju -- recimo mu frekvenčna reža --
