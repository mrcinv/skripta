...
(\underline{\tilde{b}}+\delta \underline{b})^{-1}=\left(\underline{\tilde{b}}(1+\underline{\tilde{b}}^{-1}
\delta \underline{b})\right)^{-1}=(1+\underline{\tilde{b}}^{-1}\delta \underline{b})^{-1}\underline{\tilde{b}}^{-1}
\approx \underline{\tilde{b}}^{-1}-\underline{\tilde{b}}^{-1}\delta \underline{b}\, \underline{\tilde{b}}^{-1},
\label{7.2}
\end{equation}
pri čemer je $\underline{\tilde{\varepsilon}}$ označuje dielektrični in $\underline{\tilde{b}}$
inverzni dielektrični tenzor v odsotnosti zunanjega polja (nemoten tenzor).
...
\beq
\begin{split}
\frac{\partial^2 \Delta P}{\partial t^2} =&-\frac{\varepsilon_0 \tilde{\varepsilon}^2pS_0}{2i} \sum_{n} A_n(z) \exp\left(i[(k_x+nq)x+k_{z}z-(\omega+n\Omega)t]\right) \cdot \\ &\left(
...
V izrazu nastopa še amplituda deformacije $S_0$, ki pa je povezana z gostoto 
energijskega toka zvočnega valovanja. Za longitudinalne (zvočne) valove v snovi
\begin{equation}
