...
\begin{align}
n_x' &\approx n_o(1+\frac{1}{2}n_o^2r_{22}E_y)\\
n_y' &\approx n_o(1-\frac{1}{2}n_o^2r_{22}E_y)\\
n_z' &\approx n_e.
\end{align}
...
polarizaciji v smeri $x$ in $y$ enaka $n_x'$ in $n_y'$, fazna razlika med 
...
Če tak kristal postavimo analizator, je prepuščena moč 
Osnovna zamisel je, da z električnim
