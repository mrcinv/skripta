...
cilindričnih vlaknih, ostala pa najpogosteje pri planarnih valovodnih strukturah.

\subsection*{Čelna sklopitev}
\index{Sklopitev v optično vlakno!čelna sklopitev}
Pri izračunu izkoristka sklopitve svetlobe v optično vlakno vpeljemo 
...
rodov pa sledi prekrivalni integral, ki ga moramo seveda ustrezno normirati. Za sklopitev v rod, 
...
dx\, dy \right)}.
\end{equation}
Če računamo sklopitev svetlobe v osnovi rod vlakna, je priročno osnovni rod 
nadomestiti z Gaussovim profilom z ustreznim efektivnim polmerom (po enačbi~\ref{Marcuse}). 
...
\section{Sklopitev med valovodi}
