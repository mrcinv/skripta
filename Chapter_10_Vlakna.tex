...
\caption{Gostota svetlobnega toka in smer električna poljske jakosti za TE$_{01}$ rod}
\label{fig:TE01}
\end{figure}
Podobno kot smo zapisali sekularno enačbo v valovnem vodniku (enačba~\ref{sekular1}) tudi tukaj
zapišemo enačbo, s katero lahko določimo $k_s$. Ob približku, da se lomna količnika 
...
oziroma z EH, če je $H_z$ po velikosti primerljiv s $H_r$ in $H_\varphi$. Njihova sekularna 
enačba je precej bolj zapletena in je niti ne bomo zapisali. Pomembno je le, da rešitev
sekularne enačbe za HE vedno obstoja, ne glede na debelino vlakna.

Za praktično uporabna optična vlakna navadno velja $n_1 \approx n_2$. Takrat se enačbe poenostavijo
in posamezni rodovi postanejo degenerirani -- imajo enako rešitev. Tako so, na primer, degenerirani
TE$_{0m}$, TM$_{0m}$ in HE$_{2m}$. Združimo jih lahko v linearno kombinacijo in dobimo bolj 
priročen LP$_{01}$ rod, NAROBEki je pretežno linearno polariziran. Ta linearno polariziran rod je v središču različen od nič in je tudi osnovni rod, ki se širi po vlaknu. Je edini, za katerega rešitev obstaja
v še tako tankem vlaknu.
Zelo dobro ga lahko opišemo s približkom Gaussove oblike $\exp(-r^2/w^2)$ po tako imenovani Marcusejevi 
formuli\footnote{D. Marcuse, Bell Syst. Tech. J. 56, 703 (1977).}
\beq 
w^2 = (0,65 + 1,619 V^{-3/2}+2,879V^{-6})a,
\eeq
kjer je $w$ efektivni polmer roda. 

Dodatna 
degeneracija se pojavi med HE$_{\nu+1,m}$ in EH$_{\nu-1,m}$ rodovi.
