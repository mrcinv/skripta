...
vlakno razširi, kar -- kot bomo podrobneje videli v naslednjem poglavju -- omejuje 
...
\beq
\tau = \frac{L}{v_g(\lambda_{\mathrm{max}})} - \frac{L}{v_g(\lambda_{\mathrm{min}})} = 
...
\beq
\tau = - \left(\frac{\lambda}{c_0}\frac{d^2n_1}{d\lambda^2} \right) L \Delta \lambda = 
D_m L\, \Delta\, \lambda,
\eeq
...
vir svetlobe, da zmanjšamo $\Delta \lambda$. Za snovi, ki so v uporabi, lahko celo izberemo 
tako valovno dolžino, pri kateri je koeficient materialne disperzije enak nič. Še najbolj uporabna
...
Prispevek valovodne disperzije je praviloma najmanjši. Znaten postane v enorodovnih 
vlaknih v območju, kjer je materialna disperzija zelo majhna ali celo enaka nič.
