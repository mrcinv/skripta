...
in dobimo 
\begin{equation}
\frac{d^{2}\zeta}{dx^{2}}+\left(k_{0}^{2}\, n^{2}\left(r\right)-\beta^{2}-\frac{1}{4R^2}\right)\,\psi+\frac{1}{R}\,
\left(\frac{d\psi}{dx}-2\,\beta^{2}x\,\psi\right)=0.
\label{9.35}
\end{equation}

kar le za $2/4R^2$ spremeni $\beta^2$. Zadnji člen v gornjem izrazu
$2 \beta^2x/R \varphi$ ima enako obliko kot potencialna energija delca
v konstantnem električnem polju. Ker je preostali del enačbe za delec
v končni potencialni jami, ima rešitev enake lastnosti kot stanje delca
v končni potencialni jami z zunanjim električnim poljem. Tako potencialno 
energijo kaže slika ... Očitno je, da bo delec, ujet v jamo, lahko tuneliral preko
potencialne batiere. 
