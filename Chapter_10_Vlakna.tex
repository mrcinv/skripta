...
\boxeq{10:overlap}{
\eta = \frac{|\int \psi_1(r, \varphi) \psi_2(r, \varphi) r\, dr\, d\phi|^2}
...
Do zdaj smo govorili o svetlobi, ki potuje po valovnem vodniku ali vlaknu. Oglejmo si, kako
svetlobo sploh sklopimo v optični vodnik. Sklopitev je možna na več načinov, omenimo 
čelno sklopitev, pri kateri sklapljamo svetlobo v vlakno vzdolžno, sklopitev s prizmo, 
sklopitev preko uklonskih rež ali sklopitev med dvema vzporednima vlaknoma. Prvi način 
navadno uporabljamo pri cilindričnih vlaknih, ostale pa pri planarnih valovodnih strukturah.

\subsection*{Čelna sklopitev}
Pri izgubah na spoju dveh vlaken smo vpeljali prekrivalni integral, ki pove, kolikšen
del osnovnega roda, ki izhaja iz prvega vlakna, se sklopi v osnovni rod drugega. Povsem 
podobno pristopamo tudi pri izračunu sklopitve svetlobe v optično vlakno. Izračunati 
moramo, koliko vpadne svetlobe $E(r, \varphi)$ se sklopi z izbranim rodom vlakna $n,m$
\beq
\eta = \frac{|\int E(r, \varphi) E^*_{m,n}(r, \varphi) r\, dr\, d\phi|^2}
{\left(\int |E(r, \varphi)|^2 r\, dr\, d\varphi \right) \left(\int |E_{m,n}(r, \varphi)|^2 
r\, dr\, d\varphi \right)},
\eeq
oziroma v kartezičnih koordinatah
\beq
\eta = \frac{|\int E(x,y) E^*_{m,n}(x,y) dx\, dy|^2}
{\left(\int |E(x, y)|^2 dx\,dy \right) \left(\int |E_{m,n}(x, y)|^2 
dx\, dy \right)}.
\eeq


Če računamo sklopitev v osnovi rod vlakna, da tudi tokrat iz praktičnih razlogov 
nadomestimo z Gaussovim profilom z efektivnim lomnim količnikom. 
