...
\caption{Zaradi disperzije se dolžina sunkov svetlobe, ki potujejo skozi vlakno, 
močno poveča, zato jih na izhodu iz vlakna ne moremo več ločiti.}
\label{fig:disp}
\end{figure}

Naj bo svetloba, ki potuje skozi vlakno, modulirana v obliki kratkih sunkov, 
ki nosijo zapis informacije. Kratki sunki svetlobe potujejo z grupno hitrostjo 
\begin{equation}
...
vrste disperzije: rodovno, materialno in valovodno. Rodovna
disperzija, ki je daleč največja, je posledica dejstva, da se različni 
rodovi po vlaknu širijo z različnimi hitrostmi. Do materialne disperzije 
pride zaradi odvisnosti lomnega količnika vlakna od 
valovne dolžine svetlobe. Valovodna disperzija pa se pojavi zaradi 
nelinearne zveze med valovnim številom $\beta$ in krožno frekvenco valovanja. 
Poglejmo si disperzije podrobneje.

\subsection*{Rodovna disperzija}
\index{Disperzija!rodovna}
\index{Optično vlakno!večrodovno}
Na primeru planparalelnega vodnika smo pokazali, da vsaki rešitvi sekularne 
enačbe~(enačbi~\ref{sekular1} in \ref{sekular2}) ustreza en lastni rod v vlaknu.
...
podaljša. Izračunajmo razliko med časom, ki ga za širjenje po vlaknu potrebuje osnovni rod,
 in časom, ki ga za premagovanje iste razdalje potrebuje zadnji še dovoljeni rod.
...
$n_2$ lomni količnik plašča. 
Za prehod vlakna z dolžino $L$ tako potrebuje osnovni rod
\beq
t_0 = \frac{L}{v_{g0}} = \frac{L}{\frac{d\omega}{d\beta_0}} = L \frac{d\beta_0}{d\omega} = 
L\frac{n_1}{c_0},
\eeq
zadnji rod pa 
\beq
t_N = \frac{L}{v_{gN}} = \frac{L}{\frac{d\omega}{d\beta_N}} = L \frac{d\beta_N}{d\omega} = 
L\frac{n_2}{c_0}.
\eeq
Razširitev sunka zaradi rodovne disperzije je tako 
\boxeq{DispRod}{
\tau_r \approx 
\frac{L}{c_0} (n_1-n_2).
}
Količina podatkov, ki jo lahko prenašamo po vlaknu, je kar približno obratno sorazmerna z dolžino
izhodnih sunkov svetlobe. Za $1~\si{\kilo\meter}$ dolgo vlakno z razliko lomnih količnikov 
$\Delta n = 0,05$  je tako največja frekvenca modulacije okoli $10~\si{\mega\hertz}$, kar je 
znatno premalo za današnje telekomunikacijske potrebe. Čeprav lahko disperzijo zmanjšamo 
...
Rešitev je odvisna od valovne dolžine svetlobe oziroma njene krožne frekvence. Valovno število  

je tako nelinearna funkcija krožne frekvence, zaradi česar pride do disperzije. Če naredimo podoben 
...
\label{ValD}
\end{equation}
Upoštevamo zvezo med valovno dolžino in krožno frekvenco in zapišemo 
\begin{equation}
...
sorazmerna z dolžino izhodnih sunkov svetlobe. Pri celotni disperziji 
...
Rayleighovega\index{Rayleighovo sipanje} sipanja na termičnih fluktuacijah gostote, 
...
Pojav vodi do spektralne razširitve in zaradi\index{Čričkanje}
