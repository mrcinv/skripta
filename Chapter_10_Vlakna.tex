...
s črno barvo, desna pa za tri različne vrednosti $V$. Pri velikem $V$ (modra črta) ima sistem tri 
...
$k_s a \le k_0 a\,NA = V$. Po drugi strani pa leva stran enačbe postane pozitivna šele pri 
$J_0 (k_s a)  = 0$, to je pri $k_s a= 2,405$. Da ima tak sistem vsaj eno rešitev, mora veljati
$V>2,405$, najmanjši polmer vlakna, po katerem se TE$_{01}$ (ali TM$_{01}$) valovanje 
z dano valovno dolžino sploh širi po vlaknu, pa je 
\boxeq{10_cutoff}{
...
Poglejmo zdaj rešitve, pri katerih $\nu \neq 0$. V tem primeru je 
...
Na splošno poznamo pri potovanju svetlobe po optičnih vlaknih tri 
