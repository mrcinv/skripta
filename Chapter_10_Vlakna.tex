...
Oglejmo si le njihovo obliko. Najpomembnejši hibridni rod je HE$_{11}$ (slika~\ref{fig:HE11}), ki
je v središču različen od nič. To je osnovni rod, za katerega rešitev sekularne enačbe vedno obstaja in se
zato širi po še tako tankem vlaknu. Po obliki je zelo podoben Gaussovi funkciji $\exp(-r^2/w^2)$,
zato ga lahko razmeroma dobro opišemo s takim približko, pri čemer efektivni polmer snopa
