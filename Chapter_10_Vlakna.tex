...
\end{equation}
pri čemer je sprememba navadno majhna. Če zapišemo enačbo z lomnimi količniki, dobimo
\begin{equation}
n^2\left(r\right)=n_{1}^{2}- n_2^2 \frac{r^2}{a^2},
\label{9.15}
\end{equation}
pri čemer smo vpeljali priročnejšo konstanto $n_2$, $a$ pa označuje polmer vlakna.
Enačbo lahko tudi razvijemo za majhen $n_2$ in za vse smiselne vrednosti $r$
ima tudi lomni količnik parabolični profil.
Parabolična
