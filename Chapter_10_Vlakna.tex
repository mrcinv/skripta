...
modro obarvan del pomeni plast dielektrika (vodnik), belo pa plašč. Levo so 
prikazane prve tri sode rešitve, desno pa prvi dve lihi.
}
\label{fig:TESodi}
\end{figure}
...
Za konec lahko izračunamo še moč, ki se širi po sredici, tako da integriramo gostoto svetlobnega
toka po sredici in plašču. Delež valovanja, ki se širi po plašču, narašča z naraščajočim rodom.
...
Upoštevajoč le končne funkcije zapišemo rešitev v sredici kot
\beq
...
\eeq
Gostota svetlobnega toka v osi vlakna je za TE in TM valove enaka nič (glej sliko~\ref{fig:TE01}), 
zato sklepamo, da to niso osnovni načini širjenja svetlobe po cilindričnem vlaknu.
\begin{figure}[h]
\centering
