...
in sunek se po prehodu skozi vlakno podaljša. Pri obravnavi materialne disperzije
...
V snoveh, ki jih uporabljamo za izdelavo optičnih vlaken, je $D_m$ reda 
...
dolžino, pri kateri je koeficient materialne disperzije enak nič. Za SiO$_2$\index{SiO$_2$} je to pri okoli $1300$--$1500~\si{\nano\meter}$, odvisno od dopiranja stekla. Še najbolj uporabna je rešitev, pri kateri 
z materialno disperzijo izničimo vpliv drugih disperzij in na ta način zmanjšamo skupno 
disperzijo v vlaknu.
...
Koeficient valovodne disperzije je praviloma najmanjši, reda 
$1$--$10~\si{\pico\second/\nano\meter\,\kilo\meter}$. 
...
Kljub temu zaradi končne spektralne širine sunka svetlobe disperzije 
v optičnem vlaknu ne moremo nikoli povsem odpraviti. Pri celotni disperziji 
...
Razvijmo jo pri $z=0$ po krožnih frekvencah z ustreznimi amplitudnimi faktorji 
\begin{equation}
...
\label{9.67a}
\end{equation}
nato pa še enkrat in dvakrat po $t$. Primerjamo dobljene odvode in dobimo enačbo
\begin{equation}
...
spreminja njegova vzdolžna oblika oziroma njegova dolžina. Poglejmo, kako.

Enačba~(\ref{9.71}) je zelo podobna obosni valovni enačbi, le da ima tukaj vlogo 
prečne koordinate čas $\tau$. To, kar je bila prej širina snopa, je zdaj torej dolžina sunka.
Po analogiji s snopi lahko sklepamo, da se najmanj 
podaljšuje ravno sunek z Gaussovo časovno odvisnostjo. Celotnega računa
...
\end{equation}
nato pa z neposredno integracijo (enačba~\ref{eq:ovojnica967}) pokaži, 
da je podaljšan sunek pri $z\neq 0$ enak ovojnici, zapisani z enačbo~(\ref{9.72}), pri čemer je
\begin{equation}
\zeta_0 = \frac{\mu}{2 a}.
\end{equation}
\end{definition}
