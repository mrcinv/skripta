...
Osnovni LP$_{01}$ je kar približno enak osnovnemu HE$_{11}$ rodu. Jakost električnega polja je 
\begin{equation}
...
\right \} \, J_0(k_s r),
\end{equation}
saj ima dve možni smeri polarizacije. Na splošno so LP$_{0m}$ podobni rodovom HE$_{1m}$. 
