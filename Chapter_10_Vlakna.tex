...
Pravimo tudi, da vsak $N$ določa en rod valovanj v vlaknu. 


Po drugi strani pa obstoja v vodniku največji $k_\perp$, ki je določen 
s kotom totalnega odboja 
\beq
k_{\perp \mathrm{max}} \approx k_0 n_1 \cos\vartheta_c = k_0 \sqrt{n_1^2 -n_2^2}.
\eeq
Možnih rešitev za $k_\perp$ je torej končno 

. Z vsakim $N$ je določen en \textit{rod }valovanj
v vlaknu. 
Ker je omejen $k_{\perp}$, je število rodov je navzgor
omejeno: $N_{\max}\simeq k_{0}a/\pi\sqrt{2n\Delta n}.$  Število rodov
