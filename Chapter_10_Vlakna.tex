...
\beq
NA = \sin \alpha = n_1 \sin \beta = \n_1 \sin(\pi/2-\vartheta) =
n_1 \cos\vartheta = n_1 \sqrt{1-\sin^2\vartheta}.
\eeq
...
so osnovne značilnosti valovanja po vodniku ali vlaknu.
...
frekvenci določa največjo možno vrednost 
$k_{\perp\max}\simeq n_{1}k_{0}\cos\vartheta_{c}=k_{0}\sqrt{n_{1}^{2}-n_{0}^{2}}\simeq k_{0}\sqrt{2n\Delta n}$,
