...
frekvenco in enako fazo. Zaradi različnih dolžin poti 
...
frekvenci $\omega$, imenujmo intenziteta\index{Intenziteta}
...
\index{Interferenca} na dveh ozkih režah. Osvetljujmo zdaj zaslon z dvema
...
navzkrižna korelacijska funkcija polj $E_{1}$ in $E_{2}$ iz obeh.\index{Navzkrižna korelacijska funkcija} 
