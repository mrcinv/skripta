...
interferenco na režah\index{Interferenca}, če bo razlika poti delnih valovanj manjša od $c\, t_{c}$.
...
Časovno koherenco\index{Koherenca!časovna} je najlažje obravnavati 
...
Poglejmo še nekaj značilnih koherenčnih dolžin\index{Koherenčna dolžina}. 
...
kjer je 
\beq
F(\omega)=\frac{1}{2\pi} \cdot \int_{-\infty}^{\infty}f(t)e^{-i\omega\tau}\, d\tau
\eeq
...
izginejo, približno 
\begin{equation}
\delta s\approx d\sin\varphi\approx d\frac{R}{z}\sim\lambda\;\Rightarrow\;
...
Faktor pred integralom $-i/\lambda$ smo dobili iz uklonske teorije (enačba~\ref{eq:Fresnelov-uklon}).
Tako je 
\begin{equation}
