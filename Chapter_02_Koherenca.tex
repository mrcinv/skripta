...
konstantno fazo, to je v časovnem intervalu $t_{c}$. Valovni
paket dolžine $t_{c}$ mora tako vsebovati frekvence v pasu $\Delta\omega$,
...
so na detektorju interferenčni vrhovi in doline. Pri zakasnitvah,
...
različno dolgih optičnih poti, zato namesto koherenčnega časa velikokrat 
uporabljamo koherenčno dolžino\index{Koherenčna dolžina} $l_{c}=ct_{c}$. 
...
$\Delta\omega$.
Spekter je potem\footnote{Gostota svetlobnega toka\index{Gostota energijskega toka} 
...
oblike spektra. V plinih pa je pogosto prevladujoča razširitev črt
