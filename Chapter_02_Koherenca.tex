...
\end{equation}
Amplitude $A_{n}$ predstavljajo delež polja pri frekvenci $\omega=n\Delta\omega$, 
čas $T$ pa označuje čas opazovanja in mora biti bistveno daljši od $t_{c}$. 
Za končne vrednosti $T$ so amplitude $A_n$ slučajne spremenljivke. Povprečje  
izračunamo kot limito $T\rightarrow\infty$, da rezultat ni odvisen od konkretnega
vzorca svetlobnega polja. Zapišemo amplitude $A_n$
\begin{equation}
...
je rezultat za $J(P_{1},P_{2})$ veljaven v obeh območjih.\index{Fraunhoferjev uklon}
