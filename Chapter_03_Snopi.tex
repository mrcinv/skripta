...
ravna in meje snopa niso vzporedne, ampak se zaradi uklona širi (slika \ref{fig:Uklon-na-rezi}).
\begin{figure}[h]
\centering
\includegraphics[width=12truecm]{slike/03_lom_na_rezi.png}
...
Fraunhoferjevo uklonsko teorijo\index{Fraunhoferjev uklon}. Vendar za oceno kota širjenja
podrobnega računa niti ne potrebujemo. Velja približno 
\begin{equation}
\vartheta\simeq\frac{\lambda}{a},
\label{eq:kot_ocena}
\end{equation}
...
gornji nastavek v Helmoltzovo enačbo (\ref{eq:valovna-enacba})
...
\noindent
Za ravni val, ki je rešitev prvotne točne valovne enačbe \ref{eq:valovna-enacba}
...
\end{eqnarray}
Realni del eksponenta opisuje širjenje snopa. Vpeljimo polmer snopa\index{Polmer snopa}
$w$: 
\begin{equation}
w^{2}=\frac{2z_{0}}{k}\left[1+\left(\frac{z}{z_{0}}\right)^{2}\right].
\end{equation}
V izhodišču pri $z=0$ je snop najožji in pravimo, da je tam grlo snopa\index{Grlo snopa}. 
...
\begin{figure}[h]
\centering
\includegraphics[width=10truecm]{slike/03_Gauss.png}
...
Kot nastavek za rešitev valovne enačbe (\ref{eq:valovna-enacba})
izberemo
\begin{equation}
...
\begin{table}[t!]
 \centering
  ...
  Opis prehoda & Skica & Matrika za prehod \\ \hline   
      Prehod skozi prostor za $d$ & \parbox[c]{6em}{\includegraphics[width=0.8in]{slike/matrika_d.png}} & 
      $\begin{bmatrix} 1 & d\\  0 & 1 \end{bmatrix}$ \\ \hline

      Prehod preko meje dveh snovi & \parbox[c]{6em}{\includegraphics[width=0.8in]{slike/matrika_n.png}} & 
      $\begin{bmatrix} 1 & 0\\ 0 & \frac{n_{1}}{n_{2}} \end{bmatrix}$ \\ \hline
      
      Prehod preko konveksno ukrivljene meje $R>0$ & \parbox[c]{6em}{\includegraphics[width=0.8in]{slike/matrika_nR.png}} & 
      $\begin{bmatrix} 1 & 0\\ \frac{(n_{1}-n_{2})}{n_{2}R} & \frac{n_{1}}{n_{2}} \end{bmatrix}$ \\ \hline
      
      Prehod preko konveksne leče $f>0$ & \parbox[c]{6em}{\includegraphics[width=0.8in]{slike/matrika_f.png}} & 
      $\begin{bmatrix} 1 & 0\\ -\frac{1}{f} & 1 \end{bmatrix}$ \\ \hline
      
      Odboj na konkavnem zrcalu $R>0$ & \parbox[c]{6em}{\includegraphics[width=0.8in]{slike/matrika_R.png}} & 
...
\begin{tabular}{|c|c|c|} \hline
  Opis prehoda & Skica & Matrika za prehod \\ \hline   
      Prehod skozi prostor in lečo & \parbox[c]{6em}{\includegraphics[width=0.8in]{slike/matrika_df.png}} & 
      ...
      \parbox[c]{6em}{\includegraphics[width=0.8in]{slike/matrika_fd.png}} & 
      ...
      Prehod čez zaporedje plasti & \parbox[c]{6em}{\includegraphics[width=0.8in]{slike/matrika_nN.png}} & 
