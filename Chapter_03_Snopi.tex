...
ki je funkcija koordinate $z$, zapišemo kot\index{Gaussov snop!polmer}
\begin{equation}
...
Polmer snopa v grlu označimo z $w_0$ in zapišemo hiperbolično odvisnost $w(z)$
\boxeq{eq:w}{
...
so shematsko prikazane valovne fronte ravnega vala, 
Gaussovega snopa (enačba~\ref{eq:gaussov-snop}) 
in krogelnega vala (enačba~\ref{eq:krogelni-val}). Vidimo, da je za majhne 
oddaljenosti od grla $z$ Gaussov snop podoben ravnemu valu 
...
zamaknjena za $\pi/2$ glede na ravni in krogelni val. 
...
obravnavi preslikav Gaussovih snopov čez leče.
