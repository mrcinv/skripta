...
Pokaži, da celotna moč v snopu enaka $P = \frac{1}{2}\pi w_0^2 I_0$.
\end{definition}
...
Indeksa $n$ in $m$ določata število vozlov v prečni smeri,
polmer snopa pa narašča z $n$ in $m$. 
...
je prikazanih nekaj oblik amplitud $|\Re\psi_{p,l}(r,\varphi,0)|$.
...
enak razdalji do točke. Leča točko na osi preslika v točko na osi,
...
ki določa lego grla na desni strani leče, druga pa povečavo
...
Za primer vzemimo snop iz He-Ne laserja (valovna dolžina $632,8~\si{\nano\metre}$), ki ima grlo s 
...
\eeq
Če torej želimo doseči čim manjše grlo ob prehodu skozi lečo, mora biti polmer
...
oddaljenostjo $y$ od osi in naklonom $\theta$ glede na os sistema. Ti dve količini 
...
optičnih sistemov, saj ga je prav lahko izvesti z računalnikom. Poleg
