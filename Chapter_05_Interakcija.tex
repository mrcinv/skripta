...
Naj na dvonivojski plin vpada močan snop monokromatske svetlobe s frekvenco $\omega_S$,
...
atomov v spodnjem stanju tako nastane vdolbina, pravimo ji tudi Bennettova
vdolbina\footnote{Ameriški fizik William Ralph Bennett Jr., 1930--2008.}, 
v gornjem stanju, ki je bilo na začetku prazno, pa dobimo
ustrezen ozek vrh (slika \ref{fig:Bennet}). Širina vdolbine je določena
...
absorbirane svetlobe nastane Bennettova vdolbina. Enako obliko ima 
...
koeficient potem izračunamo s seštevanjem po porazdelitvi ${\cal Z}(v)$
(enačba~\ref{eq:jabs})
\begin{equation}
...
${\cal Z}(v)$, kot jo kaže slika (\ref{fig:Bennet}). Vdolbina ima obliko
...
pojavita dve Bennettovi vdolbini in v koeficientu absorpcije
dve tako imenovani Lambovi vdolbini\footnote{Ameriški fizik in nobelovec 
...
prehodih zmanjša (slika \ref{fig:Lamb}).
\begin{figure}[h]
\centering
\def\svgwidth{140truemm} 
