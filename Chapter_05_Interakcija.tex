...
z ustrezno energijo absorbira, atom pa preide iz nižjega energijskega stanja v višje (slika~\ref{sl4.1}\,b). 
...
Atom v vzbujenem stanju ni stabilen, temveč prej ali slej spontano preide v nižje stanje. Temu pojavu
pravimo spontano sevanje\index{Spontano sevanje} ali spontana emisija (slika~\ref{sl4.1}\,c).
...
črta\index{Spektralna črta} najpogosteje kar 
...
pomembna oblika spektralne gostote elektromagnetnega polja $u(\omega)$. V prvem primeru je 
...
\label{AB}
Zasedenost stanj\index{Zasedenost stanj} določa število atomov v določenem stanju. 
...
energije plinu oziroma {\it črpanjem}\index{Črpanje}.
...
nekim parom nivojev. Tako črpanje uporabljamo na primer v argonskem laserju\index{Laser!argonov}. 
...
Tako so opazovane frekvence posameznih atomov $\omega$
...
Zato lahko vpeljemo kreacijske in anihilacijske operatorje\index{Operator!kreacijski}
...
\label{eq:rabi4}
\end{eqnarray}
Pri tem smo vpeljali Rabijevo frekvenco\index{Rabijeva frekvenca}
\begin{equation}
...
ampak tudi od njegove amplitude električne poljske jakosti. Zelo groba ocena
...
vrsti dvonivojskih sistemov, ki interagirajo z spreminjajočim se zunanjim poljem. Poznamo jih 
na primer pri jedrski magnetni resonanci (NMR) ali kvantnih logičnih vezjih.
\end{remark}
