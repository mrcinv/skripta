...
Označimo krajevni del rešitve~(enačbe~\ref{eq:stojece_votlina}) z 
...
v stanju $\alpha$ je potem pri velikem številu stanj \index{Sevanje črnega telesa}
\begin{equation}
...
na interval valovne dolžine\index{Spekter!Planckov} je
\begin{equation}
...
Enačbo (\ref{4.35}) brez težav integriramo 
\begin{equation}
