...
Opiše spektralno gostoto energije svetlobe\index{Spektralna gostota energije}, izsevane iz 
...
širino. Najpogosteje je atomska spektralna črta\index{Atomska spektralna črta} kar 
...
Zapisani enačbi
veljata le, kadar je spektralna gostota \index{Spektralna gostota energije}
...
S $S$ smo označili presek snopa, z $V$ pa volumen plina. Gostota 
...
energije plinu. Dovajanju energije v sistem pravimo tudi črpanje\index{Črpanje}. 
...
V polprevodnikih \index{Polprevodniški laserji}dosežemo obrnjeno zasedenost med prevodnim in valenčnim
...
\begin{equation}
{\cal N}_{1}(v)+{\cal N}_{2}(v)={\cal N}(v)\mbox{\hskip1cm in 
\hskip1cm}\frac{d{\cal N}_{2}(v)}{dt}=-\frac{d{\cal N}_{1}(v)}{dt}.
\label{4.86}
\end{equation}
...
atomov v spodnjem stanju tako nastane vdolbina\index{Bennetova vdolbina}, 
...
koeficient\index{Absorpijski koeficient} potem izračunamo s seštevanjem 
...
${\cal Z}$, saj sta širini lahko različni.
