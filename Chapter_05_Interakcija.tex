...
za Nd:YAG\index{Laser!Nd:YAG} pri $1064~\si{nm}$ in širini prehoda 
...
črpanje prevlada nad majhnim presekom in pride do močnega ojačenja.\index{Optično ojačevanje}
...
s širino črte $\Delta \omega_L = 2\gamma$ (glej sliko~\ref{fig:SpekterAc}). Homogena razširitev je 
lahko večja od obratne vrednosti razpadnega časa nivoja. V plinu lahko trki motijo le fazo sevanja, 
ne da bi povzročili prehod, v trdni snovi pa homogeno razširitev brez prehoda povzročajo
termična nihanja lokalnega električnega (kristalnega) polja. 
...
črte ($7,5~\si{\mega\hertz}$). Še bolj izrazite so razširitve v trdninskih laserjih, 
na primer v Nd:YAG laserju \index{Laser!Nd:YAG}, v katerem je širina črte
...
atomov tako nastane vdolbina\index{Bennettova vdolbina}, 
...
\label{eq:rabi4}
\end{eqnarray}
Pri tem smo vpeljali tako imenovano Rabijevo frekvenco\index{Rabijeva frekvenca}
\begin{equation}
