...
\frac{1}{2}\frac{\mathbf{B}^{2}}{\mu_0}\right)+\mathbf{E}\cdot\frac{\partial\mathbf{P}}{\partial t}-
\mathbf{M}\cdot\frac{\partial\mathbf{B}}{\partial t}.
\label{eq:PoyntingTh}
\end{equation}
...
w=\frac{1}{2}\epsilon\epsilon_{0}\mathbf{E}^{2}+\frac{1}{2}\frac{\mathbf{B}^{2}}{\mu\mu_{0}}.
}
...
hkrati pa pravokotni na valovni vektor $\mathbf{k}$ (naloga~\ref{naloga-TEM-ortogonalnost}).
...
\end{equation}
Kadar v razvoju zadošča uporaba le linearnih členov, govorimo o Fraunhoferjevem
...
\end{equation}
Glavne osi elipsoida sovpadajo z glavnimi osmi tenzorja $\underline{\epsilon}$, 
