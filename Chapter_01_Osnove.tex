...
da ime pojavu: \index{Dvolomnost}dvolomnost (slika~\ref{fig:dvolomnost}). Pri zapisu \index{Lomni 
zakon}lomnega zakona (enačba \ref{eq:lomni_zakon}) v anizotropnih snoveh moramo biti pazljivi. 
