...
v lomni količnik\index{Lomni količnik}, ki pove, kolikokrat je hitrost svetlobe v snove manjša
...
Os $x$ je pravokotna na vpadno ravnino in kaže iz lista.}
\label{fig:Lom}
\end{figure}

Z $E_1$ označimo jakost električnega polja vpadnega valovanja, z $E_2$ prepuščenega in z $E_3$ odbitega.
...
in
\beq
r_{y}=\frac{n_{1}\cos\vartheta_{2}-n_{2}\cos\vartheta_{1}}{n_{2}\cos\vartheta_{1}+n_{1}\cos\vartheta_{2}},
...
\centering
  ...
  \input{slike/01_Brewster01.pdf_tex}
  \def\svgwidth{70truemm} 
  \input{slike/01_Brewster02.pdf_tex}
...
\begin{figure}[h]
\centering \def\svgwidth{95truemm} 
...
lomni količnik\index{Lomni količnik!redni}, $n_{3}=n_{e}$ pa izredni 
