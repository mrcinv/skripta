...
vpadni in uklonjeni val dovolj dobro popišemo z ravnim valom. 
...
vodi pri vsakem valovnem vektorju do dveh možnih rešitev in dveh različnih lomnih
 ...
 optični osi in tak kristal je optično dvoosen.
\end{remark}
...
Za vsako smer valovnega vektorja, torej za vsak kot $\vartheta$, sta možni dve rešitvi, 
...
da je $\mathbf{D} \parallel \mathbf{E}$ in $\mathbf{S} \parallel \mathbf{k}$ (c, zgoraj). Izredni žarek
