...
izračunamo koeficiente $r$ in $t$. Enačbe, ki opisujejo odvisnost odbojnosti
...
da je prepustnost za TM komponento enaka $\mathcal{T}=1$, za TE komponento pa $\mathcal{T}<1$. 
...
Brewsterjeva okna. Njihova značilnost je, da eno polarizacijo (TM) prepustijo v celoti, druge 
...
Pri vpadu na optično redkejše (sliki~\ref{fig:Brewster}\,b in d) je pomemben še en kot, to je mejni kot
...
ni enaka nič. Tam se pojavi tako imenovano evanescentno polje. To je polje, ki se širi v smeri mejne 
...
Čeprav je v optično redkejši snovi električno polje različno od nič, pa račun pokaže, da je Poyntingov
