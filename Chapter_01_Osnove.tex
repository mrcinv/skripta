...
je sorazmerna z $e^{-i \omega t}$. Z uporabo Greenovega teorema lahko izrazimo
jakost polja $E_P$ v točki $P$ s poljem na poljubni ploskvi, ki obkroža točko $P$. 
Zvezo opisuje Kirchhoffov integral\footnote{Nemški fizik Gustav Kirchhoff, 1824--1887.} 
\index{Kirchhoffov integral}
\beq
E_P = -\frac{1}{4\pi}\int \left(E\,\mathbf{n}\cdot \nabla \frac{e^{ikr}}{r}-
...
funkcijo, ki reši valovno enačbo (\ref{eq:skalarna-valovna-enačba}), ne samo $E$ in torej
...
strani zaslona (slika~\ref{***}). Vpadno svetlobo zapišemo kot
\beq
...
Kirchhoffov integral ni nič drugega kot matematična formulacija \index{Huygensovo načelo}Huygensovega 
načela\footnote{Nizozemski znanstvenik Christiaan Huygens, 1629--1695.}. 
Spomnimo se, da Huygensovo načelo pravi, da vsako točko valovne fronte lahko obravnavamo 
kot izvor novega krogelnega vala. To najlažje
