...
\varepsilon_0 \omega_{3}^{2}}{4}\left(\chi:\mathbf{e}_{1}\mathbf{e}_{2}A_{1}\,A_{2}e^{i(k_{1}+k_{2})z}
+ \chi:\mathbf{e}_{2}\mathbf{e}_{1}A_{2}\,A_{1}e^{i(k_{1}+k_{2})z}\right).
\label{8.7}
\eeq
...
ravnajmo podobno še za drugi dve valovanji. Tako dobimo sistem sklopljenih
enačb za amplitude valovanj v optično nelinearnem sredstvu
\boxeq{eq:nlAz}{
\frac{dA_{3}}{dz} &= \frac{i\omega_{3}\chi_{ef}}{2c_0 n_3} A_{1}\, A_{2}\, e^{-i\Delta kz}\\
\frac{dA_{2}}{dz} &= \frac{i\omega_{2}\chi_{ef}}{2c_0 n_2} A_{1}^*\, A_{3}\, e^{i\Delta kz}\\
\frac{dA_{1}}{dz} &= \frac{i\omega_{1}\chi_{ef}}{2c_0 n_1} A_{2}^*\, A_{3}\, e^{i\Delta kz}\label{eq:nlA3}.
}
...
Poglejmo le najenostavnejši primer frekvenčnega podvajanje, ko je 
...
Za konec še ocenimo koeficient ojačanja v nelinearnem kristalu LiNbO$_{3}$\index{LiNbO$_3$}
, v katerem želimo
