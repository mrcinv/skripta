...
$n = 2,2$, $\chi_{eff} = 5$~pm/V. Vstavimo podatke v enačbo~(\ref{opakapa}) in dobimo vrednost
...
odbojnosti za ojačani in nastali žarek pa sta blizu ena. Kadar 
je intenziteta črpalnega vala pri $\omega_3$ dovolj velika, da so izgube v resonatorju na obhod
manjše od parametričnega ojačevanja, dobimo lasersko nihanje pri frekvencah $\omega_1$ in $\omega_2$. 
Frekvencni $\omega_1$ in $\omega_2$ sta določeni s pogojem za ohranitev energije in pogojem
za ujemanje faz $ k_3 - k_1 - k_2 = 0$, poleg tega pa morata sovpadati z dvema možnima lastnima
frekvencama resonatorja. 
