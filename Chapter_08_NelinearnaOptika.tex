...
uporabljamo za določanje nelinearne susceptibilnosti kristalov.\index{Makerjeve oscilacije}
...
\begin{equation}
\mathbf{P}=\frac{\mathbf{e}}{2}(\mathbf{P}_\omega e^{i(kz-\omega t)}+\mathbf{P}_\omega^{*}e^{-i(kz-\omega t)}).
\label{8.71a}
\end{equation}
...
lahko dosežemo, da potuje del valovanja z večjo valovno dolžino počasneje kot del valovanja
