...
je v sredi lomni količnik večji kot na robu, in dobimo t. i. prostorski soliton.

Ocenimo, pri kateri vstopni moči svetlobe se pojavijo prostorski solitoni. 
...
\begin{equation}
n(r)=\tilde{n}+n_2 j_0 e^{-2r^2/R^2} = \tilde{n}+n_2 j_0 \left(1 - 2\frac{r^2}{R^2}\right).
\label{8.76}
\end{equation}
