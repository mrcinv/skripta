...
usmerimo dodaten Stokesov žarek s frekvenco $\omega_s$, ki stimulira določen prehod,
se fotoni osnovnega žarka absorbirajo, izhajajo pa 
fotoni pri $\omega_s$. Povedano drugače: moč izhodne svetlobe pri $\omega_s$, ki 
je po fazi in smeri enaka vpadni, se povečuje na račun osnovnega črpalnega žarka pri
...
\caption{Prehodi med energijskimi nivoji pri Ramanovem sipanju. Pri Stokesovem sipanju
snov prevzame energijo (levo), pri anti-Stokesovem sipanju pa odda (desno).}
\label{08_Raman}
\end{figure}
...
$\omega_0$. Iz gornjega izraza je tudi jasno, zakaj gre pri stimuliranem Ramanovem
sipanju za nelinearen optični pojav tretjega reda.
...
$0,029~\si{\cm/\mega\watt}$ za LiNbO$_3$ in $0,0008~\si{\cm/\mega\watt}$ za SiO$_2$. 
V meter dolgem odseku vlakna pride tako pri intenziteti svetlobe $10^{10}~\si{\watt/\meter^2}$ 
do faktorja ojačanja $1,08$.

\begin{remark}
Pojav stimuliranega Ramanovega sevanja je posebej pomemben v optičnih vlaknih, predvsem
zaradi velike intenzitete in velike dolžine, na kateri pride do medsebojne interakcije. 
Ta pojav uporabljamo za ojačenje signala v optičnih vlaknih.
\end{remark}
...
Račun je zelo podoben računu za Ramanovo sipanjem, zato ga ne bomo ponavljali. Tudi
v tem primeru pride do eksponentega ojačenja, vendar ne smemo pozabiti, da se val širi 
v nasprotni smeri od vpadnega. Vrednosti parametra $G_B$, ki ima enako vlogo kot $G_R$, 
so na primer $0,13~\si{\cm/\mega\watt}$ za CS$_2$ in $0,0045~\si{\cm/\mega\watt}$ za SiO$_2$.
