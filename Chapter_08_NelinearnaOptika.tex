...
in podobno za $A_2$
\beq
\frac{dl^2 A_2}{d z^2} = \frac{\omega_1 \omega_2 \chi_{ef}^2|A_{30}|^2}
{16 c_0^2 n_1 n_2} A_2 = \kappa^2 A_2.
\eeq
Ob upoštevanju začetnih pogojev dobimo
\boxeq{eq:opa}{
A_1 = A_{10} \cosh (\kappa z) \\
A_2 = A_{20} \sinh (\kappa z)\label{eq:opan},
}
pri čemer je
\beq
...
izpolnimo na enak način kot pri podvajanju frekvence: v dvolomnem kristalu 
...
Pokaži, v primeru neujemanja faz $\Delta k \neq 0$ amplituda ojačevanega
žarka narašča kot 
\beq
A_1 = A_{10} \left( \cosh(\kappa z) - \frac{i \Delta k}{2 \kappa} \sinh (\kappa z) \right) e^{\frac{i \Delta k}{2}}
\frac{P_{1}}{P_{10}} = \cosh^2 \left(1 +***    \right).
\eeq
\end{definition}
