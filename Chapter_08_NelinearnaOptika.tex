...
SHG\index{SHG|see {Optično frekvečno podvajanje}} ({\it Second harmonic 
...
rišemo presek ploskve valovnega vektoja z ravnino, določeno z optično osjo in valovnim
...
vhodnih valovanj ravno enako lomnemu količniku frekvenčno podvojenega žarka $n_o^{2\omega}$. 
...
\sin\vartheta_m \nonumber \\
&=& - \varepsilon_0\, \chi_{zxy}E_{0}^2\sin(2\varphi) \sin\vartheta_m.
\label{8.151}
\end{eqnarray}
...
Navadno podvojeni signal potuje počasneje in zaostaja za osnovnim, zato iz kristala izhaja razmeroma
...
in da je $\psi_{3}$ dovolj majhen, da zmanjševanja $\psi_{1}$
...
svetlobe v $1~\si{cm}$ dolgem kristalu LiNbO$_{3}$.\index{LiNbO$_{3}$}
...
Omejimo se na najpreprostejšemi primer, pri katerem ima vpadno valovanje le eno 
...
možne načine, zato nastopajoj trije enaki členi. Sledi
\begin{equation}
...
pri katerem vpadna svetloba vpliva na lomni količnik snovi.\index{Susceptibilnost!nelinarna, efektivna}
...
Tretji primer je poljubno sredstvo, ki valovanju doda naključno
...
\index{Stimulirano Ramanovo sipanje}
\index{Stimulirano Brillouinovo sipanje}
Ko svetloba vpade na snov, se je del siplje. Poleg elastičnega Rayleighevega sipanja, 
pri katerem se energija vpadlih fotonov in tako frekvenca svetlobe ohranja, pride
...
še znatno šibkejša od že tako šibkega Ramanovega sipanja. 
Drug zanimiv primer je, kadar pride do spremembe energije 
fotonov zaradi vzbujanja akustičnih valov (fononov). Takrat govorimo o Brillouinovem sipanju\footnote{Francoski fizik L\'eon Nicolas Brillouin, 1889--1969.}. Opišimo
pojava podrobneje.

\subsection*{Stimulirano Ramanovo sipanje}
Pri spontanem Ramanovem sipanju se izsevana svetloba siplje v vseh smereh 
s poljubno fazo. Če pa na snov poleg osnovnega žarka s frekvenco $\omega_0$ 
usmerimo dodaten Stokesov žarek s frekvenco $\omega_s$, pa ki stimulira določen prehod,
se fotoni osnovnega žarka absorbirajo, izhajajo pa 
fotoni pri $\omega_s$. Povedano drugače: moč izhodne svetlobe pri $\omega_s$, ki 
je po fazi in smeri enaka vpadni, se povečuje na račun osnovnega žarka pri
$\omega_0$. Tako pride do močnega resonančnega
ojačenja svetlobe pri $\omega_s$ oziroma do stimuliranega Ramanovega sipanja. 
Preostali del energije prevzamejo molekule, ki preidejo v vzbujeno vibracijsko stanje. 

Obravnavajmo snov kot $N$ neodvisnih enodimenzionalnih harmonskih oscilatorjev. Nihanje
posameznega oscilatorja opišemo z enačbo
\beq
...
\label{srs:F}
\eeq
pri čemer smo polarizabilnost $\alpha$ razvili v Taylorjevo vrsto do prvega člena
\beq
...
nato pa v enačbo osilatorja (enačba~\ref{srs:X}). Sledi
\beq
...
\label{srs:chi}
\eeq
Efektivna susceptibilnost za svetlobo pri frekvenci $\omega_s$ je 
torej kompleksna in sorazmerna intenziteti vpadne laserske svetlobe pri osnovni frekvenci
$\omega_0$. 

Kompleksna susceptibilnost seveda pomeni tudi kompleksni lomni količnik. Če upoštevamo
le prve člene v razvoju, se vpadna svetloba se po snovi širi kot
\beq
...
\label{nalogasrs}
 ...
 nato pokaži, da je imaginarni del efektivne susceptibilnosti  (enačba~\ref{srs:chi}) 
 vedno negativen. 
\end{definition}
Krajši račun pokaže (naloga~\ref{nalogasrs}), da je imaginarni del efektivne susceptibilnosti
vedno negativen in električna poljska jakost eksponentno narašča. 

Če je razlika frekvenc vpadne svetlobe ravno enaka vibracijski frekvenci, je sistem v 
resonanci in ojačenje največje. Za primer: ojačenje rubinovega laserja v $1~\si{\cm}$ 
dolgi plasti CS$_2$ je pri moči laserja $1~\si{\watt}/\si{\micro\meter}^2$ enako $2$, zelo 
podobno vrednost dobimo tudi za LiNBO$_3$. 
...
se tako pojavi še svetloba pri frekvenci $\omega_0-\omega_f$, pri čemer 
$\omega_f$ označuje frekvenco akustičnega vala. Obe valovanji se pojavita le v točno
določenih smereh in nad določeno intenziteto vpadne svetlobe. Najmočnejši pojav je 
...
valovnih vektorjev enaka nič. Poleg tega se izkaže, da je intenziteta Brilouinnovega
sipanja sorazmerna z valovnim številom akustičnega vala, zato je 
opazovanje v nasprotni smeri vpadne svetlobe najučinkovitejše.



V vlaknih se kljub šibki ojačitvi signal močno ojači. Odvisnost Brillouinovega 
premika od temperature in pritiska deluje kot senzor. 

Tega ne bomo izpeljevali.
