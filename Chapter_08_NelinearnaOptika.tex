...
Kerrovim pojavom, je $n_{2}=2 \cdot 10^{-18}$~m$^{2}$/W. Tedaj dobimo
po gornji formuli za kritično moč pri valovni dolžini 1~$\mu$m vrednost 
\beq
P_{s}=\frac{\lambda^2}{16 \pi n_2} = 10^{4}~\mathrm{W}.
\eeq
...
ustrezni moči snop povsod konstnatno širino in obliko. Takim snopom 
...
zaostaja (slika~\ref{fig:chirp}b). Zadji del sunka, ki ima nižjo frekvenco, bo torej 
