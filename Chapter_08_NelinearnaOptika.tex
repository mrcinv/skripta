...
Iz tega sledi, da lahko ojačujemo samo valovanja, ki imajo nižjo 
frekvenco od črpalnega vala in so zato najbolj
uporabna za ojačevanje signalov v infrardečem območju. 
\begin{figure}[h]
\centering
\def\svgwidth{100truemm} 
...
Izhajajmo iz splošnih enačb za nelinearne optične pojave drugega reda (enačbe~\ref{nlAz} do
\ref{nlA3}). 
\begin{eqnarray}
...
\frac{dA_{1}}{dz} &=&\frac{i\omega_{1}\chi_{ef1}}{4c_0 n_1} A_{2}^*\, A_{3}\, e^{i\Delta kz}.
\label{eq:opaA}
\end{eqnarray}
...
\begin{eqnarray}
\frac{dA_{1}}{dz} &=& \frac{i\omega_{1}\chi_{ef}}{4c_0 n_1} A_{2}^*\, A_{30} \qquad \mathrm{in}\\
...
Dobimo
\beq
\frac{\partial^2 A_1}{\partial z^2} = \frac{\omega_1 \omega_2 \chi_{ef}^2|A_{30}|^2}
{16 c_0^2 n_1 n_2} A_1 = \kappa^2 A_1
\eeq
in podobno za $A_2$
\beq
\frac{\partial^2 A_2}{\partial z^2} = \frac{\omega_1 \omega_2 \chi_{ef}^2|A_{30}|^2}
{16 c_0^2 n_1 n_2} A_2 = \kappa^2 A_2.
\eeq
Ob upoštevanju začetnih pogojev dobimo
\boxeq{eq:opa}{
A_1 = A_{10} \cosh (\kappa z) \\
A_2 = A_{20} \sinh (\kappa z),
}
pri čemer je
\beq
...
in
\beq
A_{20} = i \frac{\omega_2 n_1}{\omega_1 n_2}.
\eeq
