...
posameznega oscilatorja opišemo z enačbo\index{Harmonski oscilator}
\begin{equation}
...
vpadne laserske svetlobe pri osnovni frekvenci
...
zaradi velike intenzitete in velike dolžine, na kateri pride do medsebojne interakcije, zato
ga uporabljamo za ojačenje signala v optičnih vlaknih.\index{Optično ojačevanje!v vlaknih}
\end{remark}
...
Račun je zelo podoben računu za Ramanovo sipanje, zato ga ne bomo ponavljali. Tudi
v tem primeru pride do eksponentnega ojačenja, vendar ne smemo pozabiti, da se val širi 
v nasprotni smeri od vpadnega. Vrednosti parametra $G_B$, ki ima enako vlogo kot $G_R$, 
so na primer $0,13~\si{\cm/\mega\watt}$ za CS$_2$ \index{CS$_2$}
