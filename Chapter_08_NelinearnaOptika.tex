...
\beq
\mathbf{E}_{i}  = \frac{\mathbf{e}_{i}}{2}\left[A_{i}(r,z)\, 
e^{i(k_{i}z-\omega_{i}t)}+A_{i}^{*}(r,z)\, e^{-i(k_{i}z-\omega_{i}t)}\right],
\eeq
...
\beq
\psi_i = \sqrt{\frac{n_i}{\omega_i}}A_i.
\eeq
...
\begin{equation}
\kappa=\frac{\chi_ef}{c_0} \sqrt{\frac{\mu_{0}}{\epsilon_{0}}\frac{\omega_{1}\omega_{2}\omega_{3}}{n_{1}n_{2}n_{3}}}.
\label{8.20}
\end{equation}
...
Nelinearno mešanje treh valov, ki ga opisujejo enačbe \ref{8.8},
