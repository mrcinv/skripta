...
in spekter izhodne svetlobe.Intenzitete izhodnih žarkov niso risane v merilu.}
\label{fig:nl2}
\end{figure}
\vglue-10truemm
\begin{remark}
...
Nehomogene valovne enačbe na splošno ne znamo rešiti in se moramo zateči k približkom.
...
\end{eqnarray}
Polja smo zapisali v realni obliki s kompleksno konjugiranimi
...
$\omega_{3}$. Dobimo\footnote{Spomnimo, da je 
...
narašča sorazmerno s kvadratom dolžine kristala (enačba~\ref{8.10}). Takšna odvisnost velja le, 
če je $j_{2\omega}$ bistveno manjša od $j_{\omega}$ oziroma $A_3 \ll A_1, A_2$. 
...
\end{equation}
pri čemer je $j_\omega$ gostota svetlobnega toka pri osnovni frekvenci. 
...
gostota svetlobnega toka osnovnega žarka ne zmanjšuje, je odvisnost parabolična (rdeča krivulja), kar 
...
$\Delta k=0$ in $n=1,5$. Pokaži, da je
...
optičnih vlaknih, predvsem zaradi velike intenzitete in velike dolžine, *** \index{Optično ojačevanje!v vlaknih}
\end{remark}
...
se tako pojavi še Stokesova svetloba pri frekvenci $nu_s = \nu_0-\nu_f$, pri čemer 
