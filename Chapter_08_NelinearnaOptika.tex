...
\eeq
Če vpeljemo nelinearni lomni količnik\index{Lomni količnik!nelinearni}
\boxeq{eq:n2}{
...
snop. Zaradi samozbiranja deluje vzorec kot leča, njena goriščna razdalja
...
Poglejmo še primer. \index{CS$_2$}V CS$_{2}$, ki je tekočina z razmeroma velikim optičnim
Kerrovim pojavom, je $n_{2}=3 \cdot 10^{-18}$~m$^{2}$/W. Tedaj je
...
ampak imajo konstantno dolžino sunka. Stacionarne rešitve obstojajo le v primeru, kadar je  $d^{2}k/d\omega^{2}<0$ oziroma kadar ima drugi odvod nasprotni predznak od nelinearnega lomnega količnika. 
