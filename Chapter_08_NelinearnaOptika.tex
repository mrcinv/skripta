...
\begin{equation}
\left(\mathbf{P}_{\mathrm{NL,3}}\right)_i= \epsilon_{0}\sum_{jkl}\chi^{(3)}_{ijkl} \,E_j \,E_k\, E_l
= \epsilon_{0}\chi^{(3)}_{ijkl} \,E_j \,E_k\, E_l.
\end{equation}
...
Zanimivi posledici lomnega količnika, odvisnega od intenzitete vpadne svetlobe, 
