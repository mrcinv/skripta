...
Razlika faze pri obhodu je 
\begin{equation}
\frac{\omega_{n}}{c}2L-\left[\arctan \left(\frac{z_{2}}{z_{0}}\right)+\arctan \left(\frac{-z_{2}}{z_{0}}\right)+
\arctan\left(\frac{z_{1}}{z_{0}}\right) + \arctan\left(\frac{-z_{1}}{z_{0}}\right)\right]=n2\pi
\label{eq:fazan}
\end{equation}
...
tako natančno. Kadar imamo opravka le z osnovnim
snopom, nam podobno ni treba upoštevati člena
