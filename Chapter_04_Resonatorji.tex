...
\begin{equation}
\Delta\omega=\frac{\pi c}{L} \quad \mathrm{in}\quad \Delta \nu=\frac{c}{2L}.
\label{eq:deltaomega}
\end{equation}
...
razliko resonančnih frekvenc $\Delta \nu$ 
(enačba~\ref{eq:delta-omega-resonator}) in širino resonance $2/\tau$. 
Za opisani primer velja $\Delta\omega\tau/2 = 2 \pi \Delta \nu \tau/2\approx 80$.
...
frekvenca $\nu_n \sim 10^{15}~\si{\second}^{-1}$, širina pa reda 
