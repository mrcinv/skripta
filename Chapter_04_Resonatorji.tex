...
Resonatorjem, ki zadoščajo gornjima pogojema, pravimo stabilni resonatorji\index{Stabilnost resonatorja}.
...
$
pravimo tudi Fresnelovo število\index{Fresnelovo število}.
...
električnega polja uporabimo obosno valovno\index{Obosna valovna enačba} enačbo (enačba~\ref{eq:obosna-valovna-enacba}). 
...
Gaussovih snopov\index{Gaussov snop} (enačba~\ref{eq:gaussov-snop}). Podobno kot zapišemo stoječe valovanje na vrvi kot
...
Poglejmo primer. Naj bo dolžina resonatorja laserja $L=1~\metre$ in valovna
...
\begin{remark}
V praksi se včasih uporabljajo tudi nestabilni resonatorji\index{Resonator!nestabilen}, to je
...
stabilnost\index{Stabilnost resonatorja}, zapisan s koeficienti matrike $M$:
...
(glej nalogo~\ref{naloga-spekter}) in dobimo Lorentzovo krivuljo\index{Lorenzov spekter} s širino črte, ki ustreza ravno
\begin{equation}
...
integrala\index{Kirchhoffov integral} (enačba~\ref{eq:Fresnelov-uklon})
\begin{eqnarray}
...
resonator z dvema vzporednima ravnima zrcaloma in resonator z dvema sferičnima zrcaloma.
Poleg teh dveh primerov je še cela vrsta različnih resonatorjev. Ciklični resonator je
sestavljen iz več zrcal in žarek ciklično potuje med njimi. V vlakenskih laserjih je resonator
kar vlakno med dvema zrcaloma ali pa ciklično sklenjeno vlakno. Kot laserski resonator lahko 
delujejo tudi mikroploščice ali mikrokroglice, v katere je s totalnim odbojem ujeta svetloba. 
Namesto zrcal v mikroresonatorjih uporabimo tudi periodične dielektrične strukture, na katerih 
pride do Braggovega odboja. 
\end{remark}
...
% klasično obliko kreacijskih in anihilacijskih operatorjev v kvantno-mehanskem 
...
% se zato povečajo za (enačba~\ref{eq:taucca}) $1/\tau=c/(4L)(1-{\cal R})$. Druga posledica
...
% izračunamo amplitudo nihanja v stacionarnem stanju. Da dobimo konstantno amplitudo, 
% mora imeti nihanje enako frekvenco kot vpadni val. Potem dobimo
% \begin{equation}
